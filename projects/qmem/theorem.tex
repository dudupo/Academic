...
\begin{equation*}
  \begin{split}
    \sum_{i \in [d+1]}\min \{  L_{i}(p),  L_{i}(\psi(p)) \} = \sum_{i \in [d]}\min \{  L_{i}(p),  L_{i}(\psi(p)) \} - \min \big\{ \sum_{i \in [d]} L_{i}(p),\sum_{i \in [d]} L_{i}(\psi(p)),\big\}
  \end{split}
\end{equation*}
Thus,  
      \begin{equation*}
      ...
      & \le \Size{A} + \Size{\psi(B)}  =  \Size{A} + \Size{\psi(B)} 
    \end{split}
  \end{equation*}
