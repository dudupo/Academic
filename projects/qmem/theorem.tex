...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
No step admits a slice of size at least $cn$ at its corresponding analysis of Toom's contour, so the decoder successfully restores the logical state; in other words, no logical error occurs.
\end{proof}
