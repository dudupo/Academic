...
\begin{proof}
  ...
  \inb{ \textbf{ Remove what comes next. } }
...
\inb{\textbf{ We need the intermediate theorem only for a restriction to register. And yet, we need the max-size for the induction. }}
\begin{claim}
