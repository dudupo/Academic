...
\begin{claim}
  ...
  \begin{equation*}
    \begin{split}
      \Size{A\cup \psi(B)} \le \Size{A} + \Size{\psi(B)} = \Size{A} + \Size{B}
    \end{split}
  \end{equation*}
\end{claim}
\begin{proof}
  ...
  \begin{equation*}
    \begin{split}
      ...
      & \le  \sum_{ i \in [d+1]}  \max_{v \in A } L_{i}(v) + \max_{v \in \psi(B) } L_{i}(v) -  \min \{  L_{i}(p),  L_{i}(\psi(p)) \}  \\
      & \le  \sum_{ i \in [d+1]}  \max_{v \in A } L_{i}(v) + \max_{v \in \psi(B) } L_{i}(v) -  L_{i}(p)  \\
      & \le \Size{A} + \Size{\psi(B)}   - \sum_{ i \in [d+1]}  L_{i}(p)  =  \Size{A} + \Size{\psi(B)} 
    \end{split}
  \end{equation*}
