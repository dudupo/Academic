...
In this work, we present a fault-tolerance construction that uses the 4D Toric code and has a constant-depth 'correction' cycle. 
...
In other words, we showed that non-hierarchical correction cycle is not a property belongs only to the good quantum LDPC or the Hyperproduct code.
