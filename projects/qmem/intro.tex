...
\end{enumerate}
Notice that the vertices of $\mathcal{H}$ with no incoming arrows correspond to faults. Then, they show that at the end of the run, the probability for a cluster of flipped bits to be connected via arrows decays exponentially in the perimeter of the cluster.
