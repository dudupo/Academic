...
As mentioned, we are going to analyze the likelihood of getting logical errors by looking back in time and ask what a run that has led to them is supposed to look like. The problem, with that is 
