...
We first needed to find an analog for Toom's rule. We decided to adopt the sweep rule invented by Preskill and Kubica in \cite{Kubica_2019}. They also provided a rigorous proof for simplicial Toric that the sweep rule can decode when run in the absence of noise. For our purposes, we consider topological codes induced by cubical Toric\footnote{The standard Toric codes.}.
