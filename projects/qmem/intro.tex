...
\Cref{subsection:model} formalize the computation model and the computation graph presentation (splitting to steps). In particular, see \Cref{claim:intersyn} for the formal proof of the intermediate argument. 
