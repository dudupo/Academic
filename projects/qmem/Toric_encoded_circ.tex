  ...
  \begin{definition}[Tooms Contour Graph of $C(\mathcal{E})$]
    ...
    \begin{enumerate}
      \item The vertices $V_{\mathcal{H}}$ are the vertices of faces supporting the reduced Pauli-path. Namely:
        \begin{equation*}
          \begin{split}
            V_{\mathcal{H}} \colonequals & \big\{ v_{t} \times \{X\} : v_{t}=(v,t) \in V_{o} \text{ and there exists a face } f \in \text{ supp } X(P_{t}) \text{ such } v \in f \big\} \\
            & \bigcup \big\{ v_{t} \times \{Z\} : v_{t}=(v,t) \in V_{o} \text{ and there exists a face } f \in \text{ supp } Z(P_{t}) \text{ such } v \in f \big\} 
          \end{split}
        \end{equation*}
