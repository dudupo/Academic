        ...
        \begin{enumerate}
          \item If $g$ is either a logical Pauli, a measurement in the computational base, or an identity, then for any face $f$ in the register on which $g$ acts, we add:
            \begin{equation*}
              ...
              \end{split}
            \end{equation*}
          \item \inb{\textbf{In fact we don't do that, since we are going to uses the replacement argument-\Cref{claim:replace}.}}   If $g$ is a measurement in the phases base, then for any face $f$ in the register on which $g$ acts, we add:
            \begin{equation*}
              \begin{split}
