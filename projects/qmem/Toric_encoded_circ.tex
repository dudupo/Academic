...
\begin{definition} 
  \label{def:paulipath}
 \inb{\textbf{ Define a reduced Pauli here. }}  Finally, we define a reduced Pauli-path $\tilde{P_{1}}, \ldots, \tilde{P}_{\mu+1}$ to be the Paulis obtained by taking a Pauli-path, considering its view in the $\infty$-extension, and for any finite connected chain that corresponds to a subset of the $X$ component of $P_{t}$'s support, substitute it with its reduced form (\Cref{def:reduced}). Then do the same for the $Z$ component in the dual picture. Observes that Paulis of a reduced Pauli-path acts on the qubits in the $\infty$-extension. 
