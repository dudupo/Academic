...
\begin{definition}
  ...
  \begin{enumerate}
    \item We define $t^{\star}$ as the time of the gate at step $\tau$ plus one, and then add for the vertices in $V_{\mathcal{H},\{X\}}$ the duplication of the previous layer, namely the subset:
      \begin{equation*}
          \begin{split}
            \bigl\{ v_{t^{\star}}  & : v_{t^{\star}}=( \{X\}, v,t^{\star}) \text{ such there exists a face } f \in \text{ supp } P_{t^{\star}-1} \\ 
      ...
      \begin{equation*}
          \begin{split}
            \bigl\{ v_{t^{\star}}  & : v_{t^{\star}}=( \{Z\}, v,t^{\star}) \text{ such there exists a face } f \in \text{ supp } P_{t^{\star}-1} \\
