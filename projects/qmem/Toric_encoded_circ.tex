...
\begin{definition}[Tooms Contour Graph of $C(\mathcal{E})$, (Standard form)]
    ...
    \begin{enumerate}
      \item The vertices $V_{\mathcal{H}}$ correspond to vertices of faces supporting the reduced Pauli-path. They consist of the triple $(v,t,\cdot)$ where $(v,t)$ is a vertex of the base graph, and the third is a symbolic coordinate that is either $\{X\}$ or $\{Z\}$ corresponding to the component of the Pauli that $v$ supports at time $t$.
        \begin{equation*}
          \begin{split}
