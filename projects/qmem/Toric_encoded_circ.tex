...
\inb{\textbf{ Consider defining the Pauli-path recursively: $P_{i}$ is a reduced Pauli, then $Q_{i+1}$ supports $C|_{i} \circ P_{i}|_{[w]}$, and $P_{i+1}$ is the reduced form of the $\infty$-extension of $Q_{i+1}$. }}
