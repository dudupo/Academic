  ...
  \begin{enumerate}
    ...
    \item If $g$ is a measurement of the $i$ qubit, namely:  
      \begin{equation*}
        ...
        \end{split}
      \end{equation*}
      Then we use the identities $\braket{0}{0} = \frac{1}{2}( I + Z )$ and $\braket{1}{1} = \frac{1}{2}( I + Z )$, So
      \begin{equation*}
        \begin{split}
          g \circ \bigl( P \Phi_{\tau}(\rho) Q \bigr)  &=  \frac{1}{2}( I \pm Z )P^{\prime} \bigl( g \circ \Phi_{\tau}(\rho) \bigr) Q^{\prime} \frac{1}{2}( I \pm Z ) \\
     &=        \frac{1}{2}( I \pm Z )P^{\prime} \bigl( g \circ \Phi_{\tau}(\rho) \bigr) Q^{\prime} \frac{1}{2}( I \pm Z ) \\
        \end{split}
      \end{equation*}
    \item If $g$ is one of $\textbf{CX}, \textbf{X}$ or $\textbf{Z}$, then 
      \begin{equation*}
