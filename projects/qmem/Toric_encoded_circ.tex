...
As a concept, if the base graph is a recording of a run from the Torices' point of view, then a \textit{Tooms contour} is a recording of the deviation's evolution in the eyes of the Torices' vertices. We use the notion of Pauli-path to describe a deviation:
...
For a reduced Pauli-path $P_{1},..,P_{\mu+1}$ (\Cref{def:paulipath}), the Tooms contour is the restriction of the base graph to vertices that witness a deviation, namely, those that belong to qubits supporting $P_{1},P_{2},..,P_{\mu+1}$. 
