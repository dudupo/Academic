...
Denote by $I_{i} \subset S^{\prime}_{i}$ the generators, on the path from the root $u_{i}$ to the vertex $v$, namely:  
\begin{equation*}
  \begin{split}
    v = \bigl(\prod_{g \in I_{1}} g \bigr) u_{1}  =   \bigl(\prod_{g \in I_{2}} g \bigr) u_{2}  = v
  \end{split}
\end{equation*}
By inverting the two sides we get:  
\begin{equation*}
  \begin{split}
    \Rightarrow & \bigl(\prod_{g \in I_{1}} g \bigr)^{-1} u^{-1}_{1}  =   \bigl(\prod_{g \in I_{2}} g \bigr)^{-1} u^{-1}_{2}  \\
    \Rightarrow & \bigl(\prod_{g \in I_{1}\cap S_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{1}/S_{2}} g \bigr)^{-1} u^{-1}_{1}  =   \bigl(\prod_{g \in S_{1} \cap I_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{2} / S_{1}} g \bigr)^{-1} u^{-1}_{2}  \\
    \Rightarrow & \bigl(\prod_{g \in I_{1}\cap S_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{2}/S_{1}} g \bigr) u^{-1}_{1}  =   \bigl(\prod_{g \in S_{1} \cap I_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{1} / S_{2}} g \bigr) u^{-1}_{2}  
  \end{split}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    \Rightarrow & u^{\prime}_{1}  =  \bigl(\prod_{g \in I_{1}\cap S_{2}} g \bigr) \bigl(\prod_{g \in S_{1} \cap I_{2}} g \bigr)^{-1} u^{\prime}_{2}  
  \end{split}
\end{equation*} So they have sources at distance at most $2d^{\prime}$. 

Since $d^{\prime} \le d/2$, it follows that there exists $J \subset S$ such that $J \subset S \setminus (S_{1} \cup S_{2})$, and $|J| = |I_{1} \cap I_{2}|$.

\ctt{Something is messed up}
