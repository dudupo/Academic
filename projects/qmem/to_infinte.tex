...
On a location encoded in the register coordinate system, we can act via shifting, which matches the given location to a shifted location on the suitable infinite Toric.
