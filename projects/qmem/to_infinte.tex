...
Let $u=(g,l)$ be a decoding gate, and let $v_{0},v_{\pm 1}, v_{\pm 2} ,v_{\pm d} $ be its rooted translation in the $\infty$-extension such that $v_{\pm i} = \pm \mathbf{1}_{i} * u$. Then
  \begin{equation*}
    \begin{split}
      v_{0}(\prod_{i}v_{\pm i})|_{[w]} = u.
    \end{split}
  \end{equation*}
\end{claim}
\begin{proof}
