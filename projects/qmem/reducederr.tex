...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item Assume the correction of the claim for dimensions lower than $d, d^{\prime}$. Consider a generators subset $J \subset S$ and let $z \in \mathcal{C}_{v}^{J}$. In addition, consider a generator $g \in J$.
      ...
      Now, since $w^{*} \in \text{Stab}_{v}^{J/g}$, then $\partial^{-}w^{*} = 0$. In particular, $w^{*}$ can be decomposed into a sum of stabilizers rooted in $v$. Let $\rotfv{v}{S^{\prime}_{1}}, \rotfv{v}{S^{\prime}_{2}}, \rotfv{v}{S^{\prime}_{3}}, \ldots, \rotfv{v}{S^{\prime}_{l}}$ be the $d^{\prime}$-dimensional chains corresponding to the stabilizers composing $w^{*}$. Namely:
      \begin{equation*}
        \begin{split}
