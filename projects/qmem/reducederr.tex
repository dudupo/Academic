...
\begin{proof}
  ...
  \begin{enumerate}
    \item Base. For the base cases, let $d$ be any number greater or equal to three, and let $d^{\prime}$ be two. First, observes that, in the case $d^{\prime}=2$, the code $\mathcal{C}_{v}^{J}$ is a the Tanner code, where the bits are set on edges of the form $\{vg_{i}, vg_{j} \}$ and checks are associated with vertices of the form $\{vg_{i} \}$. Therefore any codeword is a cycle. Let:
      \begin{equation*}
        \begin{split}
          \{vg_{1},vg_{2}\},\{vg_{2},vg_{3}\},..,\{vg_{k},vg_{1}\}
        \end{split}
      \end{equation*}
      Be the cycle corresponds to $z$. Namely: 
      \begin{equation*}
        \begin{split}
      ...
      \begin{equation*}
        ...
        \end{split}
      \end{equation*}
      Clearly, $w \in \text{Stab}_{v}^{J}$, and in addition it's restriction to $v$ equals: 
      \begin{equation*}
        \begin{split}
