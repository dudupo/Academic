...
Observe that the collection $R_{1}, \ldots, R_{d+1}, J_{1}, J_{2}, \ldots$ is a connected collection of slices and forks in which the $R_{i}$s are leaves. Thus, we can repeat the proof in \Cref{claim:prevslices}, concurrently repeat the process for choosing the $z_{j}^{i}$s, and get the inequality.
