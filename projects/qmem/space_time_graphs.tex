...
\end{enumerate} 
For any vertex $v \in V$ of the space-time graph, denote by $\pre{v}$ the set of vertices defined as follow: 
    \begin{equation*}
      \begin{split}
\pre{v} \colonequals \{ u \in V \colon \{u,v\} \in A \text{ and } \Time{u} = \Time{v} + 1 \}
      \end{split}
    \end{equation*}
