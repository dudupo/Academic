...
\inb{\textbf{ Extend the above to chains at hamming distance at most $\Delta$.  }}
...
Now, define for any $i,j \in [1 + \Delta t] $ quantity: 
\begin{equation*}
  \begin{split}
...
\begin{equation*}
  \begin{split}
    \Size{ w_{i \Delta +1 ,(i+1)\Delta + 1} }  \le \sum_{j = i \Delta +1 }^{(i+1)\Delta} \Size{ w_{j ,j + 1} } \le  \Delta d + \Delta M(d,d^{\prime}) c n  
  \end{split}
\end{equation*}
\end{proof}
