...
\end{claim}
\begin{proof}
  Let $x^{\prime}$ be the $\infty$-lift of $x$, we argue that the projection of any subset $y \subset x^{\prime}$, which doesn't contain a vertex $v$ and a translation of it $v + \mathbb{1}_{g} n$, can't closes a non-trivial loop. 
\end{proof}
