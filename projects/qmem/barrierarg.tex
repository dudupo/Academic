...
We argue that each connected component of $\partial^{-}x^{\prime}$ has a size of at most $\Delta c n$ (\inb{\textbf{Prove that!}}). Now, define for any $i,j \in [1 + \Delta t]$ the quantity:
\begin{equation*}
  \begin{split}
