...
\begin{proof}
  Let $\tilde{C}[\mathcal{E}]$ be the quantum circuit obtain from $C[\mathcal{E}]$ by spreading each turn to an whole time unit. Then we use \Cref{claim:prevslices}, yet only a finite number of qubits is involved.. 
\end{proof}
