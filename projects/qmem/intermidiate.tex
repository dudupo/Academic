...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
We argue that we can assume, without loss of generality, that the term $ \Trr{} \big( (g \circ \tilde{P}_{1} )  \tilde{P}_{2} \big) $ is non-zero. To see this, suppose that it vanishes; then there has to be another Pauli term $\tilde{P} \in \mathcal{P}$ in the decomposition of $\mathbf{A}$ for which:
\begin{equation*}
    \begin{split}
