...
\inb{\textbf{Rewrite.}} We give the proof in the appendix for several reasons. First, the argument is not the core of this work. Second, versions of it appear in almost any fault tolerance work. Additionally, it relies on 'propagation of entire layers,' a term that conflicts with the 'propagation to a step' (\Cref{def:localprop}) needed for the intermediate theorem.
\begin{claim}
