...
We give the proof in the appendix since the argument is not the core of this work, as it appears in almost any fault tolerance work, and in addition, it relies on 'propagation of entire layers', a term that collides with the propagation (\Cref{def:localprop}) we need for the intermediate theorem.
\begin{claim}
