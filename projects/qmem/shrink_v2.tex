...
\end{proof}
We finished analyzing the first part of the sweep-cycle that acts in the computational basis. In the next section, we introduce the transformation into the dual code. Since the dual code is a $(d,d-d^{\prime})$-Toric code, we also find that the sweep-cycle shrinks reduced phase errors.
