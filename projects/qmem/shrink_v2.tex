...
\end{corollary}
\begin{proof}
The first inequality follows from \Cref{claim:sweepshrink} and \Cref{claim:corrdual}; for the second, we have to deal with the case in which merging of disjoint components occurs. 
\end{proof}
