...
\begin{definition}
  For a $(2d^{\prime},d^{\prime})$-Toric code, we define the realization of Hadamard gate by $ H^{\otimes (\cdot) } \circ \phi \circ \psi$ followed by $d + d^{\prime}$ times sweep-cycle (See also \Cref{corollary:hadamard}). 
\end{definition}
\begin{claim}
