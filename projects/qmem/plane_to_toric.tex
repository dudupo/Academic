...
\end{claim}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      ...
      \end{split}
    \end{equation*}
    We start by bounding the contribution of the right term, \Cref{coro:edgefaultratio} states that the ratio of leaves to edge in explanation is at least $\frac{1}{80(d+1)^{2}}$  and by \Cref{claim:big_subtree} it follows that any such explanation has more than  $\frac{1}{2}n^{\frac{d^{\prime}}{d}}$ edges contain a  subtree with less than  $\frac{1}{4}n^{\frac{d^{\prime}}{d}}$ edges with leaves to edges ratio that is greater than $\frac{1}{2} \frac{1}{80(d+1)^{2}}$. For this we use the union bound to show that there is no vertex in the base graph that is a root for a tree with   $V_{o}$ 

  \begin{equation*}
    \begin{split}
      \prbm{  \bar{A}_{\tau}    }{ \sim \mathcal{N}_{\mathcal{E}} } \le nwd \alpha^{ \frac{1}{4} n^{\frac{d^{\prime}}{d}} } p^{ \frac{1}{8}  n^{\frac{d^{\prime}}{d}}}
    \end{split}
  \end{equation*}
