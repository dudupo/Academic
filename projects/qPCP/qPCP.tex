...
\begin{definition} \label{definition}  
  ...
  \begin{equation*}
    \begin{split}
      M[H,\zeta] = \sum_{q\in[n]}{ M[H,q,\zeta]} 
    \end{split}
  \end{equation*}
\end{definition}
...
\begin{proof}
  ...
  \begin{equation*}
    \begin{split}
      \braket{\psi|M[H,q,\zeta]|\psi} & =  \exppm{ \braket{\psi|M[H,q,\zeta]|\psi} }{\sim q} =\exppm{\prbm{ \braket{\psi|H_{i}|\psi} \ge 1 }{H_{i}\sim H(q)} \ge \zeta }{\sim q} \\
      & \le  \frac{ \exppm{ \exppm{ \braket{\psi|M[H,q,\zeta]|\psi}}{ H_{i} \sim H(q)} }{ \sim q }  }{\zeta } 
    \end{split}
  \end{equation*}
\end{proof}
