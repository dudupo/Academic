...
\end{claim}
\begin{proof}
  We will show a reduction from \CLASS instance into $k$-local Hamiltonian with constant gap. Consider the complete graph $K_{n}$. Assign for each qubit for each edge of the graph. 
\end{proof}
