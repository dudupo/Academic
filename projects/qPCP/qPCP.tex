...
\begin{remark}
  ...
  Then one can easily concludes that a solution for $\braket{n_{0},\alpha_{0}}$ limitedly implies a solution for $\braket{n_{0}^{\frac{\log (1-\alpha)}{\log ( 1 - \alpha_{0})}}, \alpha}$
\end{remark}
