...
\section{Servel Hamiltonians Constructions.}
...
\begin{definition}
  ...
  \begin{equation*}
    ...
    \end{split}
  \end{equation*}
  Where $v,u$ are connected vertices in $G$. In some sanse, any pair of adjoint layers (belongs to consective time step) are perform 'expander graph' (Yet, the total expansion of the obtained graph is still low).
\end{definition}
