...
Suppose that $\prb{\braket{\psi|H|\psi} \ge b } \le \delta $, So at most $\delta$ of the vertices has energy greater than $b$ and at least $1 - \delta$ ofthe vertices has energy less than $a$. We will say that good vertex is a negative vertex that sibiling only to one positive vertex which doesn't pass the test.  
