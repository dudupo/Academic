...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
By that, we earn that when moving the dual system the error remains the same. For that to work it seems that we have also to say something like for $\mathcal{E}^{\prime} \subset \mathcal{E}$ if things work to $\mathcal{E}$ then they also should work for $\mathcal{E}^{\prime}$. 
  }
  \begin{definition}
