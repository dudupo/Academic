...
\begin{equation*}
  \begin{split}
    ...
    \Rightarrow & \bigl(\prod_{g \in I_{1}\cap I_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{1}/I_{2}} g \bigr)^{-1} u^{-1}_{1}  =   \bigl(\prod_{g \in I_{1} \cap I_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{2} / I_{1}} g \bigr)^{-1} u^{-1}_{2}  \\
    \Rightarrow & \bigl(\prod_{g \in I_{1}\cap I_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{2}/I_{1}} g \bigr) u^{-1}_{1}  =   \bigl(\prod_{g \in I_{1} \cap I_{2}} g \bigr)^{-1}\bigl(\prod_{g \in I_{1} / I_{2}} g \bigr) u^{-1}_{2}  
  \end{split}
\end{equation*}
