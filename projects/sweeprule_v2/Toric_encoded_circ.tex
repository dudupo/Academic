        ...
        \begin{enumerate}
          ...
          \item If $g$ is logical $\phi \circ \mathbf{H}$, then for any physical $\mathbf{H}$, in its realization, that acts on face $f$, we add:
            \begin{equation*}
              ...
              \end{split}
            \end{equation*}
          \item If $g$ is one of logical $X,Z,I$ then for any face $f$, in the register on which acts $g$, we add: 
            \begin{equation*}
              \begin{split}
              ...
              \end{split}
            \end{equation*}
          \item If $g$ is a sweep-cycle $f$, in the register on which acts $g$, we add: 
            \begin{equation*}
              \begin{split}
                & \bigl\{  \{(u,t),(v,t+1)\} : u,v \in f \text{ and } u,v \in V_{\mathcal{H},X} \bigr\} \\
                & \bigl\{  \{(u,t),(v,t+1)\} : u,v \in f\text{ and } u,v \in V_{\mathcal{H},Z} \bigr\} 
            ...
            \end{equation*}
        \end{enumerate}
        In addition for any fault $g$ of $\mathcal{E}$, that is applied at time $t$, and any face $f \not \text{Sup}(g)$, we add the edges:
