...
\begin{definition}[The Boundery of Deviation $\partial D_{t}$  ]  \ 
  ...
  \begin{equation*}
    \begin{split}
      \partial \mathcal{D}^{X}_{t}  & \colonequals \bigcup_{R_{i} \in A_{t}} \partial \ket{R_{i,t}} \cup\bigcup_{R_{i} \in B_{t}} \partial \phi \circ \mathbf{H} \ket{R_{i,t}} \\
      \partial \mathcal{D}^{Z}_{t}  & \colonequals \bigcup_{R_{i} \in B_{t}} \partial \ket{R_{i,t}} \cup\bigcup_{R_{i} \in A_{t}} \partial \phi \circ \mathbf{H} \ket{R_{i,t}} 
    \end{split}
  \end{equation*}
\end{definition}
