...
\ctt{Here we should add that a vertex $v$ belongs to location $l$ if there is a qubit $f$ that $v$ belongs to its associated face. }
  ...
  \begin{definition}[Tooms Contour Graph of $C(\mathcal{E})$]
    ...
    \begin{enumerate}
      ...
      \item The edges $E_{\mathcal{H}}$ is partitioned into two types $A_{\mathcal{H}}$ and $F_{\mathcal{H}}$, where for any physical gate of $(g,l=(t,S))$ of $C[\mathcal{E}]$ we add edge to $A_{\mathcal{H}}$ as follow: 
        \begin{enumerate}
          \item If $g$ is physical $\mathbf{CX}$ between faces $f_{1}$ into $f_{2}$ at time $t$ then we add: 
            \begin{equation*}
              \begin{split}
              ...
              \end{split}
            \end{equation*}
          \item If $g$ is physical $\phi \circ \mathbf{H}$. 
        \end{enumerate}
