...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_17 = Integer(17); _sage_const_3000 = Integer(3000); _sage_const_2 = Integer(2); _sage_const_14 = Integer(14); _sage_const_65 = Integer(65); _sage_const_73 = Integer(73); _sage_const_0p005 = RealNumber('0.005'); _sage_const_0p01 = RealNumber('0.01'); _sage_const_7 = Integer(7); _sage_const_30 = Integer(30); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4); _sage_const_107 = Integer(107); _sage_const_113 = Integer(113); _sage_const_143 = Integer(143); _sage_const_22 = Integer(22); _sage_const_33 = Integer(33); _sage_const_36 = Integer(36); _sage_const_37 = Integer(37)## This file (mthesis.sagetex.sage) was *autogenerated* from mthesis.tex with sagetex.sty version 2021/10/16 v3.6.
import sagetex
