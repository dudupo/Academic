...
\uncover<3-> {\draw (13.7,4) node { \alt<5->{  QMA ? qPCP }{ \alt<3>{BQP (P) ? QMA (NP)}{BQP ? QMA}? PSPACE. }};}
...
\begin{frame}
  ...
  Another Example, the repttion code can be thought as the tanner graph defind with the parity code on the cyle graph.
