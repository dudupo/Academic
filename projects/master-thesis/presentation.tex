...
\begin{tikzpicture}[scale=0.95]
  ...
  \draw (14,6) node { Future. };
  \alt<4->{ 
    \draw (14,5) node { ''We understand quantum complexity. };
    \draw (14,4.5) node { as well as we understand classical complexity''. };
}{\draw (14,5) node { ''We understand quantum complexity''. };}
\draw (14,4) node { \alt<5>{  QMA ? qPCP }{ \alt<3>{BQP (P) ? QMA (NP)}{BQP ? QMA}? PSPACE. }}; 
