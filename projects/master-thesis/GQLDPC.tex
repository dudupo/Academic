...
\begin{proof}
  ...
  \begin{equation*}
    \begin{split}
      ...
      & \le \Theta\left( \Delta^{2} \right) \frac{  |S| }{n} +  \lambda\left( G^{\star} \right) \sqart{ \frac{ |S|}{ |S_{e}|} } \\
