...
\end{theorem}
Note that the fact that the sampling succeeds with high probability implies that with high probability the codes that are sampled have a good distance.
