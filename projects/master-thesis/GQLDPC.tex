...
Our proof does not use $p$-resistance to puncturing, yet it is a basic ingredient in~\cite{leverrier2022quantum}. Therefore, later on, we will point out where and how exactly the $p$-resistance is being used.
