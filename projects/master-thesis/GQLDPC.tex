...
The exiteness of Good qLDPC codes and LTC were considered an open problems for roughly two decades. And even those, it seems that they related only by containing the word code in their title, they proven to be exist by the same construction. First apper in \cite{Dinur} as good localy testable code and then in \cite{Pavel}.
