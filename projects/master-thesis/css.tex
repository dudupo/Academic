  ...
  \begin{proof}
    ...
    \begin{proof}
      \begin{equation*}
        ...
        \end{split}
       \end{equation*}
       And recall the dimensional theorem that states:
       \begin{equation*}
         \begin{split}
          & \dim \Ima H_{Z} + \dim \ker H_{Z} = n \\
          \Rightarrow & \dim \rnk H_{Z} + \dim \ker H_{Z} = n
          \Rightarrow & \dim \rnk H_{Z}^{\top} + \dim \ker H_{Z} = n
