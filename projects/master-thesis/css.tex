    ...
    \begin{proof}
      \begin{equation*}
       ...
       \begin{equation*}
         ...
         \end{split}
       \end{equation*} equals $1$ and therefore the summation over the vectors $y \not\in C_{Z}$ in the inner closure in \ref{equ:dualspace} must cancel. So we left only with a uniform superposition over the codewords in $C_{Z}$, In other words $H^{n}\ket{C^{\perp}} = \ket{C}$.  
    \end{proof}
    \begin{claim}
