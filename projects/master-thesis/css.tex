...
\begin{lemma}
  ...
  \begin{proof}
    ...
    \end{proof}
  \Cref{claim:mapdualAs} states that, when considering CSS codes,  pauli $X$ operators can be seen as pauli $Z$ operators in the rotated frame. That it, \begin{equation*}
    \begin{split}
