...
\begin{proof}
  We will find the dimensions of each of the classics codes defined by $H_{X}$ and $H_{Z}$. Notice that length of the code, assuming the fullness of the ranks, is $n^{2} + (n-k_{1})(n-k_{2})$ be the rank of the.  
\end{proof}
