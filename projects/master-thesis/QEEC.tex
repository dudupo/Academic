...
\begin{proof}
  ...
  \begin{equation*}
    \begin{split}
      ...
      & \mapsto  \ \ \ \ \ \GZZZ{ (-1)^{\braket{e,f} }Z^{e}\ket{ x + z} \ket{ H_{X}f }  }\\
      & \mapsto^{H^{\otimes n}} \GZZZ{  (-1)^{\braket{e,f} }Z^{e}H^{\otimes n}\ket{ x + z} } \\
      & = \GZZZ{  (-1)^{\braket{e,f} }Z^{e}H^{\otimes n} X^{x} \ket{ z} } \\
      & = \GZZZ{  (-1)^{\braket{e,f} }Z^{e} Z^{x} H^{\otimes n} \ket{ z} } \\
      & = \GZZZW{ \ket{ z} }{(-1)^{\braket{e,f} }Z^{e} Z^{x} H^{\otimes n} } \\
      & =  \GXXXW{  \ket{ z} }{ (-1)^{\braket{e,f} }Z^{e} Z^{x} } \\
    \end{split}
  \end{equation*}
\end{proof}
