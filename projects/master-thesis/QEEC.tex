...
\draw[ -> ]  (0,5) to [out=50, in=130] (5,5);
\draw[ -> ]  (0,4) to [out=130, in=50] (5,4);
\draw[ -> ]  (0,3) to [out=130, in=50] (5,3);
\draw[ -> ]  (0,2) to [out=130, in=50] (5,2);
\draw[ -> ]  (0,1) to [out=130, in=50] (5,1);
\draw[ -> ]  (0,0) to [out=130, in=50] (5,0);
\end{tikzpicture}
\end{figure}
