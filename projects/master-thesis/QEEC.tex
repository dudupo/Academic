...
\begin{claim}
  Let $k_{1},k_{2},k_{1}^{\top},k_{2}^{\top}$ be the demission of the codes with the paritiy check matrices $H_{1},H_{2},H_{1}^{\top},H_{2}^{\top}$. Then the dimension of the Hyperproduct code is $k_{1}k_{2} + k_{1}^{\top}k_{2}^{\top}$. 
