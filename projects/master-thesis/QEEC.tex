...
\begin{proof}
  ...
  \newcommand{\GZZZW}[2]{ \frac{#2}{\sqrt{|C_{Z}^{\perp}|}} \sum_{z \in C_{Z}^{\perp}}{ #1 } } 
  \newcommand{\GXXX}[1]{ \frac{1}{\sqrt{|C_{X}^{\perp}|}} \sum_{z \in C_{X}^{\perp}}{ #1 } } 
  \newcommand{\GXXXW}[2]{ \frac{#2}{\sqrt{|C_{X}^{\perp}|}} \sum_{z \in C_{X}^{\perp}}{ #1 } } 
  \begin{equation*}
    \begin{split}
      \ket{\mathbf{x}} &  \mapsto^{P} =  \frac{1}{\sqrt{|C_{Z}^{\perp}|}} \sum_{z \in C_{Z}^{\perp}}{ X^{f}Z^{e}\ket{ x + z }} = \frac{1}{\sqrt{|C_{Z}^{\perp}|}} \sum_{z \in C_{Z}^{\perp}}{ (-1)^{\braket{e,f} }\ket{ x + z + f}}\\
      & \mapsto^{H_{X}} \GZZZ{ (-1)^{\braket{e,f} }\ket{ x + z + f} \ket{ H_{X} \left(x + z + f\right) }  } \\ 
      & = \ \ \ \ \ \GZZZ{ (-1)^{\braket{e,f} }\ket{ x + z + f} \ket{ H_{X}f }  }\\
      & \mapsto  \ \ \ \ \ \GZZZ{ (-1)^{\braket{e,f} }\ket{ x + z} \ket{ H_{X}f }  }\\
      & \mapsto^{H^{\otimes n}} \GZZZ{  (-1)^{\braket{e,f} }H^{\otimes n}\ket{ x + z} } \\
      & = \GZZZ{  (-1)^{\braket{e,f} }H^{\otimes n} X^{x} \ket{ z} } \\
      & = \GZZZ{  (-1)^{\braket{e,f} } Z^{x} H^{\otimes n} \ket{ z} } \\
      & = \GZZZW{ \ket{ z} }{(-1)^{\braket{e,f} } Z^{x} H^{\otimes n} } \\
      & =  \GXXXW{  \ket{ z} }{ (-1)^{\braket{e,f} } Z^{x} } \\
    \end{split}
  \end{equation*}
\end{proof}
