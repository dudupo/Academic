...
\draw[ -> ]  (0,0) to [out=150, in=130] (0,5);
\draw[ -> ]  (1,0) to [out=150, in=130] (1,5);
\draw[ -> ]  (2,0) to [out=150, in=130] (2,5);
\draw[ -> ]  (3,0) to [out=150, in=130] (3,5);
\draw[ -> ]  (4,0) to [out=150, in=130] (4,5);
\draw[ ->]   (0,5) to [out=150, in=130] (5,5);
\end{tikzpicture}
\end{figure}

The above encoding could be also seem as extension of the tanner code, in which the graph is cayley 
