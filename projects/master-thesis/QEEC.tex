...
As similar to the classical case the next native question to ask is whether there are codes with positive rate the quantum expanders were the first quantum LDPC code do achieve a square root distance and positive rate  \cite{Tillich_2014}, \cite{Leverrier_2015}. The leaded insight was the idea that the Toric code could be represented as the cyclic product.   
