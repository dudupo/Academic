  ...
  \begin{columns}[t]
    \begin{column}{0.5\textwidth}
      ...
      \begin{center} 
        ...
        \node (C) at (-2,0) {};
        \draw[ -> ]  (-6,0) to (-1.5,0); 
        \alt<5->{  \node (D) at (-4,1) { $\ket{\textcolor{red}{0}}$ } ;}{\alt<2->{ \node (D) at (-4,1) { $1\textcolor{red}{0}$ } ; }{\node (D) at (-4,1) { $1$ } ; } }
          \alt<5->{  \node (D) at (-2.85,1.5) { $\ket{\textcolor{red}{0}11}$ } ; }{\uncover<3->{ \node (D) at (-2.85,1.5) { $\textcolor{red}{0}11$ } ; } }
        %\uncover<2->{\node (D) at (-4,1) { $110101$ } ;  
      \end{tikzpicture}
    }
    \end{center}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{center} 
        ...
        \uncover<8->{ \node (D) at (-2.85,1.5) { $ \frac{1}{\sqrt{2}}\left( \ket{000} \textcolor{red}{-} \ket{111}\right)$ } ; }  
        %\uncover<2->{\node (D) at (-4,1) { $110101$ } ;  
      \end{tikzpicture}    }
    \end{center}
    \end{column}
