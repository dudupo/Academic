...
\begin{abstract}
  We review our experimential immplemntion of algorithm for designing time eveloution simulation circuits of maleclue, given thier Hamiltonian in the pauli base. Our algorithm uses a servel huristics in order to minimaize the circuit depth. We demenostrate it, by taking the lithium malecule as use case and comparing the genrated circuit to the one genrated by the naive algorithm. 
\end{abstract}
