...
\begin{definition}
  Consider the following relation $\prec$. We will say that $H_{i} \prec H_{j}$ if $H_{j}$ could obtained by applying the replacements $I \mapsto X  $ or $ I \mapsto Z$. Note that this relation define an order (transitive). 
\end{definition}
