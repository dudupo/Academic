...
\begin{equation*}
  \begin{split}
    ...
    \end{split}
  \end{equation*}
  If we sample the terms form a uniform distrubtion over the $\Delta$-local terms then $p = \frac{ { n -1 \choose \Delta -1 }}{ {n \choose \Delta}}  = \frac{\Delta}{n}$. And therfore the excpection of the intersections is less then ${ m \choose 2}\frac{\Delta^2}{n}$.  
