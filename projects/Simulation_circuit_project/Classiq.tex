...
\begin{equation*}
\begin{split}
  D\left(n,m\right) \leq & \log_{\frac{1+\Delta}{\Delta}}\left(m\right) \cdot 2\Delta n % \left\Big( 1 + \mathbb{E}_{\sim i}[H] \right\Big)   \\ & + 4w \left( \text{MST}\left(G\right) \right) + \left(2 - \frac{1}{m}\right)n^2
\end{split}    
