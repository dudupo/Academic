...
\begin{equation*}
  \begin{split}
    ...
    \end{split}
  \end{equation*}
  If we sample the terms form a uniform distrubtion over the $\Delta$-local terms then $p =  { n -1 \choose \Delta -1 }/ {n \choose \Delta}  = \frac{\Delta}{n}$. And therfore the excpection of the intersections is less then ${ m \choose 2}\frac{\Delta^2}{n}$. Hence by markov inequality we obtin that $ \prb{ \text{intersects} \ge \frac{1}{2} { m \choose 2}  } \le \frac{2\Delta^2}{n} $
