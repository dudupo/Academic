...
\usebackgroundtemplate{ }    %% undeclare it
   ...
   \begin{exampleblock}{ Blocktitle } 
     \begin{itemize}
       \item<1-> Motivation. Engage other    (another) for computing quntumly that  Review the current 
       \item<2-> Reviwing the current state, Sharing the view of the errors correcion scientest.    
       \item<3-> Engaging.  
    \end{itemize}
  \end{exampleblock}
   \end{frame}
