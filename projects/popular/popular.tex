  ...
  \end{exampleblock}
   \end{frame}
	...
	\begin{exampleblock}{The Question.}
	    Why should we have a \only<1>{Quantum} \only<2> {\sout{Quantum} Classic} Computer?
	  \end{exampleblock}
	  \uncover<3->{ 
   		\includegraphics[height=200pt,width=200pt]{catia-21987-5.jpg}
   		\vspace*{2cm} \hspace*{3cm} \includegraphics[height=200pt,width=200pt]{what-is-catia-051120.jpg}
		\vspace*{5cm} \hspace*{6cm} \includegraphics[height=200pt,width=200pt]{rsut6ggvivt81.jpg}
	      }
