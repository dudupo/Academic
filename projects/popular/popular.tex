...
\efboxsetup{linecolor=\textcolor{OliveGreen},linewidth=1pt, margin=0.1pt}
  ...
  \end{exampleblock}
   \end{frame}
	...
	\begin{exampleblock}{The Question.}
	  \only<1>{Why should we have a Quantum Computer?}
          \uncover<2->{ Why should we have a {\sout{Quantum} Classic} Computer?}
	  \end{exampleblock}
	...
	\begin{exampleblock}{The Question.}
	  Why should we have a Quantum Computer?
	  
 \end{exampleblock}
	  \uncover<1->{ 
	    \efbox{\includegraphics[height=100pt,width=120pt]{ ammonia-moleculen.jpeg }}
	  }
	  \uncover<2->{ 
	    \efbox{\includegraphics[height=150pt,width=200pt]{h-118-das-universum-der-molekuele-1170x780.jpg}}
	  }
	...
	\begin{frame}
		\uncover<1-> {
		    \efbox{\includegraphics[height=80pt,width=350pt]{QMA-com.png}}
	  	}
	  
	  	\uncover<2-> {
	    	 \efbox{\includegraphics[height=80pt,width=300pt]{QLPDC.png}}
	  	}
	\end{frame}
