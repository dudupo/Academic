  ...
  \end{exampleblock}
   \end{frame}
	...
	\begin{exampleblock}{The Question.}
	  ...
	  \uncover<3->{ 
   		\tcbincludegraphics[hbox, size=fbox,boxsep=0.1mm, graphics options={height=100pt,width=120pt}, sharp corners, colframe=green!]{rsut6ggvivt81.jpg}
	  }
	  
	  \uncover<4-> {
	     \vspace*{-3cm} \hspace*{6cm} \tcbincludegraphics[hbox, size=fbox,boxsep=0.1mm, graphics options={height=150pt,width=120pt}, sharp corners, colframe=green!]{catia-21987-5.jpg}
	  }
	  
	  \uncover<5-> {
	    \vspace*{-3cm} \hspace*{2cm}     \tcbincludegraphics[hbox, size=fbox,boxsep=0.1mm, graphics options={height=80pt,width=100pt}, sharp corners, colframe=green!]{what-is-catia-051120}
	  }
