...
\tikz[overlay,remember picture] \node[opacity=0.4, at=(current page.center)] {
  ...
  \end{exampleblock}
   \end{frame}
	...
	\begin{frame}
		\uncover<1-> {
		  \vspace*{-3cm} \hspace*{6cm}  \efbox{\includegraphics[height=80pt,width=200pt]{QMA-com.jpg}}
	  	}
	  
	  	\uncover<2-> {
	    		\vspace*{-3cm} \hspace*{2cm}  \efbox{\includegraphics[height=80pt,width=200pt]{QLPDC.png}}
	  	}
	\end{frame}
