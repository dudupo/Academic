  ...
  \end{exampleblock}
   \end{frame}
	...
	\begin{exampleblock}{The Question.}
	  ...
	  \uncover<5-> {
	    \vspace*{-3cm} \hspace*{2cm}     \tcbincludegraphics[hbox, size=fbox,boxsep=1mm, graphics options={height=80pt,width=100pt}, sharp corners, colframe=green]{what-is-catia-051120}
	  }
