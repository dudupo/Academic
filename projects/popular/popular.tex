...
\tikz[overlay,remember picture] \node[opacity=0.4, at=(current page.center)] {
  ...
  \end{exampleblock}
   \end{frame}
	...
	\begin{frame}
		\uncover<1-> {
	    		\vspace*{-3cm} \hspace*{6cm}  \efbox{\includegraphics[height=80pt,width=180pt]{QMA-com.png}}
	  	}
	  
	  	\uncover<2-> {
	    		\vspace*{-3cm} \hspace*{2cm}  \efbox{\includegraphics[height=80pt,width=180pt]{QLPDC.png}}
	  	}
	\end{frame}
