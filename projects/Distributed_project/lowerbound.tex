...
The protocol compute the disjointness in single round while requiring transmition of less then $\Theta\left( \sqrt{n} \right)$ qubits. That in contrast to the known lower bound proved by Braverman \cite{Braverman}: 
\paragraph{Theorem A} \textit{The $r$-round quantum communication complexitiy of Disjointness$_n$ is $ \Omega\left( \frac{n}{r \log^8 r} \right)$.} 
