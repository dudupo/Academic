...
\paragraph{Theorem 3} Quadratic speedup without knowing~{\boldmath $a$}
...
and let $\chi : \integer \rightarrow \{0,1\}$ be any Boolean function.
...
$\Theta(\sqrta)$ if $a>0$, and otherwise runs forever.
