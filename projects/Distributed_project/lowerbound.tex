...
\paragraph{Lemma.}  Recall $\mathbf Q $ defined in \cite{Brassard_2002}, and consider the generaliz deffusion gate $D$, for any pair $\ket{\psi_{x}},\ket{\psi_{y}}$ defined as above. it holds that:
