...
\begin{proof}
  Let $\omega$ be an explanation of $\hat{K}$ with more than $\beta n$ vertices. Since there is no deviation cluster of size greater than $d$ until step $\tau$, we have that no vertex of $\omega$ is a   \Cref{claim:total_shrinking}     Observes that a spanning tree of $\omega$ has a ratio of edges to time-leaves which is at most $\omega$'s ratio, and number of edges equals to $\omega$'s vertices - 1. In addition the time-leaves of such spanning tree are just leaves. Therefore, by \cref{claim:big_subtree}, $\omega$ has a subtree with less than $\frac{\beta}{2}n$ edges and at least $\frac{\beta}{4\gamma} n$ time-leaves. 
