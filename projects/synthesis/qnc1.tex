 ...
 % \begin{widetext}
  ...
  \begin{equation*}
    \begin{split}
      ...
      &\le  \sum_{ P_{i} \in \mathcal{P}^{\star}}{  \prb{ P_{i}}\braket{ \psi^{\prime} | P_{i} E \psi }} \pm O(  \frac{1}{poly(n)}) \\
      & =   \sum_{ P_{i} \in \mathcal{P}/\mathcal{P}^{\star}}{  \prb{ P_{i}}\braket{ \psi^{\prime} | P_{i} E \psi }} + \sum_{ P_{i} \in \mathcal{P}^{\star}}{  \prb{ P_{i}}\braket{ \psi^{\prime} | P_{i} E \psi }}  \pm O(  \frac{1}{poly(n)}) \\ 
      & =   \sum_{ P_{i} \in \mathcal{P}/\mathcal{P}^{\star}}{  \prb{ P_{i}}\braket{ \psi^{\prime} | P_{i} E \psi }} + \sum_{ P_{i} \in \mathcal{P}^{\star}}{  \prb{ P_{i}}\braket{ \psi^{\prime} | \psi }}  \pm O(  \frac{1}{poly(n)})
    \end{split}
  \end{equation*}
