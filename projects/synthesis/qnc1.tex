 ...
 % \begin{widetext}
  ...
  \begin{equation*}
    \begin{split}
      ...
      &=  \left( \left( 1 -\frac{1}{poly(n)} \right)\sum_{P_{i} \in \mathcal{P}}P_{i}E + \frac{1}{poly(n)} A  \right)^{\dagger}= \left( 1 -\frac{1}{poly(n)} \right)\sum_{P_{i} \in \mathcal{P}}DP_{i} + \frac{1}{poly(n)} A 
\end{split}
  \end{equation*}
