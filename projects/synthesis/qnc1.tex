...
\begin{proof}
 ...
 % \begin{widetext}
  ...
  \begin{equation*}
    \begin{split}
      \mathcal{N}(D) &= \left((\mathcal{N}(D))^{\dagger}\right)^{\dagger} =  \sum_{P_{1}, P_{2}, .., P_{i} \in \mathcal{P}}{ \prb{P_{1}, P_{2}, .., P_{i}}  \left(D_{1}P_{2}D_{2},..,P_{i-1}D_{i}P_{i}\right)^{\dagger}} \\ 
	&=  \sum_{P_{1}, P_{2}, .., P_{i} \in \mathcal{P}}{ \prb{P_{1}, P_{2}, .., P_{i}}  P_{i}E_{i}P_{i-1}E_{i-1},..,P_{1}E_{1} } 
	%&= 
	%P_{i}\overbrace{E_{i}P_{i-1}E_{i-1},..,P_{1}E_{1}}^{\star}    
\end{split}
  \end{equation*}
