...
\begin{equation*}
  \begin{split}
    ...
    c & \ge \frac{2\rho}{ 1 \pm \sqrt{ 1 -  4\rho  nl\left( H(\delta) +  \delta\log_{2}\gamma\right)^{2}   }   } \rightarrow \frac{2\rho}{ 1 \pm \sqrt{ 1 -  4\rho  nl\left(  \delta\log_{2}\gamma\right)^{2}   }   }\\ 
    c & \ge  \frac{\rho}{ 1 -  H(\delta) - \delta\log_{2}\gamma } \sim \rho \left( 1 + H(\delta) + \delta\log_{2}\gamma \right)
  \end{split}
\end{equation*}
