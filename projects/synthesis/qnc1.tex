...
\begin{definition}
  Pauli channel $\mathcal{N}: \mathcal{C}\rightarrow \mathcal{C}$ defined to give on input $C \in \mathcal{C}$ the distribution over circuits $\tilde{C}$ where any even location of $(2i, j)$ of $\tilde{C}$ equals to the $(i,j)$ location of $C$, and any odd location $(2i+1,j)$ of $\tilde{C}$ is the density operator $(1-p) I + \frac{p}{3} \left(X + Y + Z  \right)$. 
\end{definition}
