...
\begin{claim}
If $C_{X}$ is a Tanner graph, for which the graph has an Hamiltonian path, then there is a subset of qubits $Q$ that satisfies the requirements in \Cref{claim:csstab}.
\end{claim}
\begin{proof}
