...
\begin{openproblem}
  Consider a fault toleracne scheme $\tilde{C}$ for a logical circuit $C$ which uses the logical gatset $V_{1}, V_{2}, .. V_{t}$. Given set of fualt toleracne logical gates $U_{1},U_{2},..U_{t}$, How the foult tolerance version of $C$ would look like when using $U_{1}, U_{2}, .. U_{t}$.  
\end{openproblem}
