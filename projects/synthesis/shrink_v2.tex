...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
The numbers of checks for $\text{Stab}_{v}$ and $\text{Stab}_{v}^{*}$ are:
\begin{equation*}
  \begin{split}
 { d \choose d^{\prime} \pm 1 } + d { d-1  \choose d^{\prime} \pm 1 }  
 \end{split}
\end{equation*}
Since the assignment $z$ on the rooted bits satisfies the rooted checks, the dimension of the left code is:
\begin{equation*}
  \begin{split}
