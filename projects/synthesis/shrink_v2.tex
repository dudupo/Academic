...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
then any local maximum of $L_{d+1}$ in $\Gamma_{z}$ is also a local maximum of $L_{d+1}$ in $\tilde{z}$ and we finish. Else, we peak such $u$, and repeat over the above where $u$ plays the role of $v$. 
