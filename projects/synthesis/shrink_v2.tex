...
\begin{definition}[$d$-Dimensional Plaquettes Toric Complex] 
  For an integers $d$ and $n$ denote the group resulted by the $d$-directed power of the $n$-order cyclic group by $\mathcal{G} = \mathbb{Z}_{n}^{\times d}$, and denote the standard generating of $\mathcal{G}$ by $S = \{ 1_{i} \colon i \in [d] \}$. We define the $d$-dimensional plaquettes toric complex to be the hypergraph obtained from the cayley graph $\text{Cay}(\mathcal{G}, S)$, by taking its vertices and edges as the $0$-facets and $1$-facets, and define the $2$-facets as the subset: 
  \begin{equation*}
    \begin{split}
