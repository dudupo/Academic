...
Denote the last gate in $C$ by $u$, and by $I = \{v_{j}\}_{-\infty}^{\infty}$ the collection of gates in $C^{\infty}$ to which $u$ is mapped. Let us split into cases, depending on whether $u$ is or is not a decoding gate.
 ...
 \begin{equation*}
   ...
   &= v_{1}\Trr{}_{/[w]}\left( \prod_{j = -\infty, j \neq 1,2}^{\infty} v_{j} \rho_{\infty}^{\prime} \prod_{j = -\infty, j \neq 1,2}^{\infty} v_{j}^{\dagger} \right) v_{1}^{\dagger} \\
   &= v_{1}\Trr{}_{/[w]}\left( \prod_{j = -\infty, j \neq 1,2}^{\infty} v_{j}^{\dagger} \prod_{j = -\infty, j \neq 1,2}^{\infty} v_{j} \rho_{\infty}^{\prime} \right) v_{1}^{\dagger} \\
   &= v_{1}\Trr{}_{/[w]}\left( \rho_{\infty}^{\prime} \right) v_{1}^{\dagger} \\
   &= v_{1} \rho^{\prime} v_{1}^{\dagger} \\
   &= \rho 
   \end{split}
 \end{equation*}
