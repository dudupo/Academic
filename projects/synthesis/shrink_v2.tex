...
\begin{proof}
  ...
  \begin{equation*}
    ...
    \end{split}
  \end{equation*}
  Since $z$ is finate, there it has maximum for $L_{d+1}$, denote by $u$ the vertex that gets the maximum, and denote by $\theta_{u,J_{1}}, .., \theta_{u,J_{l}}$ the $d$-faces in $\Theta$ that are rooted at $u$. 
