...
\begin{definition}[$d$-Dimensional Plaquettes Toric Complex] 
  ...
  First, for a vertex $v \in \mathcal{G}_{n}^{d}$, and for a subset of generators $S^{\prime} \subset S$ at size $|S| = i$ the $i$-facet rooted at $v$ and spanned by $S^{\prime}$ is:
  \begin{equation*}
    \begin{split}
      \bigcup_{I \subset S^{\prime}} \left\{  \left(\prod_{g \in S^{\prime}g}\right) v  \right\}
    \end{split}
  \end{equation*}
  The $i$-facets of the complex is the collection of all the possible rooted spanned $i$-facets induced by $\text{Cay}(\mathcal{G}_{n}^{d})$. 
