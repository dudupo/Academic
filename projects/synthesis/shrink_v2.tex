...
\begin{proof}
  ...
  \begin{enumerate}
    \item Base. For an empty circuit, $\rho_{\infty}$ is just the infinite string of zeros; thus, the restriction of it to $[w]$ locations yields a $w$-length string of zeros, which is exactly $\rho$.
