...
We argue that the process terminates, assume that $u \in \tilde{z}/z$, meaning that $u \in w|_{v}$ which implies that there is $g \in S$ such that $u = gv$, and therefore $L_{d+1}(u) = 1 + L_{d+1}(v)$.
