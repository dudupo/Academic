...
\inb{Need to decide on what should I elaborate, for example should I provide a proof for the distance and the rate of the code? }
\begin{definition}[$(d,d^{\prime})$ Toric Code] \cite{Dennis_2002}
