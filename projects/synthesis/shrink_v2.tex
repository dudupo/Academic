...
\begin{claim}
  Let $z$ be a connected assignment on the $d^{\prime}$-facet, and let $\Gamma$ be the set of vertices which are adjacent to unsatisfied checks induced by $\Gamma$. Let $I \subset [d]$, be a subset of coordinates at size $|I| \ge d^{\prime}$, and let $v$ be a vertex in $\mathcal{G}^{d}_{\infty}$ such that $v$ is a strong global maximum of $L_{I}$, at $\Gamma$. Then there is a rooted assignment $\tilde{z}$ at $v$ such  that: 
  \begin{enumerate}
    \item $z_{v} = \tilde{z}_{v}$
    \item $z$ is restricted to $I$. 
  \end{enumerate}
\end{claim}
\begin{proof}
