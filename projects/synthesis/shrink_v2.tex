...
We define $\text{Stab}_{v}$ as the following collection of assignments rooted at vertex $v$: $$
  \begin{equation*}
    \begin{split}
      \text{Stab}_{v} \colonequals  \left\{ z : \partial z  = 0 \text{ and } z \in \text{Span} \left( \left\{ \rotfv{v}{S^{\prime}/g} + \rotfv{gv}{S^{\prime}/g} , S^{\prime} \subset S , |S^{\prime}|=d^{\prime}+1 \right\} \right)
    \end{split}
  \end{equation*}
