...
\begin{definition}
  We say that a quantum circuit $C$ is $\infty$-compatible, if for any set of faults $\mathcal{E} = \{ f_{i} \}$ it holds that: 
  \begin{equation*}
    \begin{split}
      \Tr{}\left( A  C[\mathcal{E}] \ket{0}\bra{0} C[\mathcal{E}]^{\dagger} \right) =  \Tr{}_{/[w]}\left( A C^{\infty}[\mathcal{E}^{\infty}]\ket{0}\bra{0}\left(C^{\infty}[\mathcal{E}^{\infty}]\right)^{\dagger} \right) 
    \end{split}
  \end{equation*}
\end{definition}
