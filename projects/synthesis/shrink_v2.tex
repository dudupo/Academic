...
\begin{claim}
  ...
  Let $z$ be a finite assignment. Suppose that $\max_{v \in z} L_{d+1}(v) > \max_{ v \in \partial^{\pm} z}L_{d+1}(v)$, Then there is $\tilde{z} \sim_{\mathcal{C}_{X}} z$ such that $ \max_{v \in \tilde{z}} L_{d+1} < \max_{v \in z} L_{d+1} - 1$.
\end{claim}
\begin{proof}
