...
\end{claim}
\begin{proof}
First, since the Sweep rule is invariant to stabilizers, for any $\tilde{z}$ such that $\tilde{z} \sim_{C_{X}} z$, the correction applied by the Sweep rule on $\tilde{z}$ is the same as the application on $z$.
\end{proof}
