...
\begin{definition}[Assignment on The $(d^{\prime},d)$-Toric Complex]
  ...
  \begin{equation*}
    ...
    \end{split}
  \end{equation*} is a base to $\mathbb{F}_{2}^{|\mathcal{F}_{i}|}$ \inb{ Not exactly base, they are linear dependent}. Let $z$ be an assignment on the $d^{\prime}$-faces at finite size, and let $\theta_{v_{1},S^{\prime}_{1}}, \theta_{v_{2},S^{\prime}_{2}},.. \theta_{v_{k},S^{\prime}_{k}}$ be the collection of $d$-faces forms $z$, namely:  
  \begin{equation*}
    \begin{split}
