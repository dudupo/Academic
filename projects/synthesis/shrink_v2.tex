...
Else, in the case where two gates act non-trivially on qubits at $[w]$, denote those gates by $v_{1}, v_{2}$. Since we assumed that $C$ is given in its unitary decoding representation, it holds that $v_{1}, v_{2}$ are Paulis.
  \end{enumerate}
