...
\partial\tilde{\xi}|_{v_{i}} =  \partial\tilde{z}|_{v_{i}} + \partial\phi|_{v_{i}} = 0
  \end{split}
\end{equation*}
Namely, for any $i$, the $i$th vertex $v_{i}$ is not in $\tilde{\xi}$. Hence, the vertex domain of $\tilde{\xi}$ is contained in the union of the vertices of $\tilde{z}$ with the vertices of $\phi_{1}, \phi_{2}, \ldots, \phi_{k}$, substituting $v_{1}, v_{2}, \ldots, v_{k}$. Overall, we get:
\begin{equation*}
  \begin{split}
