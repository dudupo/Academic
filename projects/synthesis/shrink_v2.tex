...
We define $\text{Stab}_{v}$ as the following collection of assignments rooted at vertex $v$: 
  \begin{align*}
      \text{Stab}_{v} \colonequals  \Biggl\{ z : \partial z  &= 0 \\
      & \text{ and } z \in \text{Span} \left( \left\{ \rotfv{v}{S^{\prime}/g} + \rotfv{gv}{S^{\prime}/g} , S^{\prime} \subset S , |S^{\prime}|=d^{\prime}+1, g \in S^{\prime} \right\} \right) \Biggr\}
  \end{align*}
