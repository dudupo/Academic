...
\begin{claim}
Assume that $\sigma_{1}, \sigma_{2} \rightarrow \sigma_{0}$, then there is a fork between $\sigma_{1}$ and $\sigma_{2}$. So if we keep the history extant in a recursive manner, then we get a connected graph.
\end{claim}
