...
By repeating recursively on the above construction, we get the following corollary:
  \begin{corollary}
Let $T = (V,E)$ be a tree with $m > n$ leaves and $\tau$ edges. Then, for any $\alpha > 0$, it has a subtree with $m^{\prime} \in \left( \frac{1}{3}\alpha m, \frac{2}{3} \alpha m \right)$ leaves and at most $\frac{m^{\prime}}{m} \tau$ edges.
  \end{corollary}
