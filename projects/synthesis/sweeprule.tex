          ...
          \item $\mathbf{R} = \{ \{v_{i}, \prei{v_{i}} \} \} \cup_{i=0}^{k}{ \mathbf{R}_{i} }$ with at most 
            ...
            \begin{equation*}
              \begin{split}
                ...
                \Rightarrow &  \alpha \ge \frac{ d+ 1 + \xi - k \Size{\text{fork}}}{k}
              \end{split}
            \end{equation*}
        \end{enumerate}
        And that holds for $\alpha = d+1 + \xi$, Finally, by \cref{claim:prevslices}, the graphs induced by $\mathbf{R}_{i} \cup \mathbf{F}_{i}$ are connected, thus the graph induced by $\mathbf{R}\cup \mathbf{F}$ is also connected. Therefore, $\mathbf{W}, \mathbf{R}, \mathbf{F}$ form an explanation of $K$. 
    \end{enumerate}
  \end{proof}
