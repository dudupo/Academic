...
Consider the following generalization of the Tooms rule, each placket checks if both of its positive edges point on syndrome. If yes, then the bit flip itself. Consider an embedding of the $d$ Toric into $\mathbb{R}^{d}$, the coordinate of an edge is the mean of its ends.  
