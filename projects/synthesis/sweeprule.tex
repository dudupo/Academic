...
\begin{enumerate}
    ...
    \begin{equation*}
      ...
      \end{split}
    \end{equation*}
  \item For any subgraph $\omega \in \Omega$ the ratio of edges to time-leaves is at most $\gamma$. 
\end{enumerate}
...
\begin{proof}
  ...
  Because any $\omega$ with more than $\beta n$ vertices implies the existences of subtree with less than $\frac{\beta}{2}n$, its enough to bound by    
