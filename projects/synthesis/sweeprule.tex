...
As in the previews version we are going to track over the vertices, yet instead defining $\Gamma^{t}$ as the vertices on the domain wall $\sigma$, we define it as the vertices which are adjacent to a faulty bit.
