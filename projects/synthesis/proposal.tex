...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
Similarly, any two-qubit gate $U$ can be encoded using a proper magic state, and the gate teleportation will be composed by entangling using CNOT, then measurement, and eventually, upon the measurement result $P$, applying a correction $UPU^{\dagger}$. We refer to \cite{CITE} for further reading. 
