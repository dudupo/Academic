...
\cite{ newman2017limitationstransversalcomputationquantum}
  ...
  Having in mind the cues in favor and against \CDO, we're back to ask: is computing in the presence of noise indeed harder than computing in an ideal environment? What are the applications in both positive and negative cases?
