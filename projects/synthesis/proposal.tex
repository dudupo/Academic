...
We would like to extend the memory gadgets to work with high probability, which motivates us to define the following:
 \begin{definition}[$(\beta,\gamma)$-Memory]
 ...
 \begin{equation*}
   \begin{split}
     \prb{|\bar{J}| \ge \gamma n | \DD \text{ never fails } } & \le  \prb{|\bar{J}| \ge \gamma n \ | \ \DD \text{ never fails } , |\bar{I}| \le \beta n } \cdot \prb{|\bar{I}| \le \beta n}  \\
