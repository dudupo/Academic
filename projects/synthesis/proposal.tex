...
\end{oproblem}
 ...
 % We summarize the proposal by extensively pointing out the potential applications of the study.
  ...
  \begin{oproblem}{Quantum Advantage Without Reset Gates.}
    Does there exist problems believed to be hard classically but easy quantumly, which can be computed fault-tolerantly, without the use of reset gates? In particular, Is it possible to factor bog integers or sampling from IQP  without reset gates? 
  \end{oproblem}
