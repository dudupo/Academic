...
\end{equation*}
\end{oproblem}
Our second main problems, is wheter the previews is affermitive when restracting to finate geset, that is, we ask 
\begin{oproblem}{The Main Open Problem.}
\begin{equation*}
  \begin{split}
    \text{ Does }  \QNCG{}_{1} = \text{ noisy-}\QNCG{}_{1} \text{?}
  \end{split}
\end{equation*}
\end{oproblem}
