...
While the disjointness property is a property of a code and therefore can be thought of as a computational restriction, one can also ask if there are informational obstacles. In [newman2017limitationstransversalcomputationquantum], the authors succeeded in linking a transversal Toffoli to extremely low overhead homomorphic computation, what in turns contradict a known information theoretic bounds. 
\begin{definition}
