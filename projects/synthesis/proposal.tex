...
Gadgets.
 ...
 \begin{definition}
We say that a (quantum) error correction code is a $(\beta,\gamma)$-memory code if there is a constant depth procedure $\DD$ such that for any $I$ of size $|I| \ge (1 - \beta) n$ and $\rho \in C$, we have that:
   \begin{equation*}
     \begin{split}]
