...
In the following, we present the notations used in the paper. Readers who are familiar with the literature of coding theory and quantum fault tolerance might skip \Cref{sec:classical} and \Cref{sec:quantum} and continue directly to \Cref{sec:decoders}, which introduces less standard notations.
