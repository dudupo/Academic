...
Since we know that classical computation in the presence of noise can be computed at constant overhead in depth and in particular Noise-$\NC_{1} = \NC_{1}$, it's tempting to conclude that in this scenario $\NC_{1} \neq \QNC_{1}$.
