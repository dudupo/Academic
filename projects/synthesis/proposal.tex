...
\end{definition}
 ...
 \end{definition}
 For example, $\Po$ can be all the errors such that the syndrome graph induced by them can be decomposed into disjoint connected components, each of them of size at most $\frac{1}{100} \sqrt{n}$, and the distance between any two of them is at least $10$.
