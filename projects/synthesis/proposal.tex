...
Based on the fault-tolerance construction in \cite{aharonov1999faulttolerant}, one can obtain a $\left[ \text{polylog}(n) , (p \rightarrow q) \right]$-SP. We present below an informal description of it and refer to \cite{grospellier:tel-03364419} for more details.
