...
Gadgets.
 ...
 \begin{equation*}
   \begin{split}
     \prb{|\bar{J}| \ge \gamma n } & \le  \prb{|\bar{J}| \ge \gamma n \ | \ \DD \text{ fails } , |\bar{I}| \le \beta n } & \prb{\DD \text{ fails } , |\bar{I}| \le \beta n}  \\
     & + \prb{|\bar{J}| \ge \gamma n \ | \ |\bar{I}| \ge \beta n } & \prb{|\bar{I}| \ge \beta n} \\ 
