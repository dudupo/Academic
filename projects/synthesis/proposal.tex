...
\end{oproblem}
 ...
 % We summarize the proposal by extensively pointing out the potential applications of the study.
  ...
  Having a \CDO{} is the first stage in realizing an implementation to known problems such as factoring and phase estimation, we would like to ask in the YES scenario.
