...
If having a fault-tolerant construction that exhibits a constant multiplicative depth overhead is indeed possible, then what is the minimum distance for which there exists a code with that distance, and the code provides a universal gate set realization at constant depth?
