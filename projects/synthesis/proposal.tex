...
Classical Lower bounds \cite{AnnaGal}, \cite{185425}. \cite{10.1007/11672142_44} shows that if the given input is already encoded then the overhead size of the circuit can be $\Theta(\frac{\log n}{\log \log n})$.
