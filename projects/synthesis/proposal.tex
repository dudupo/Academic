...
\end{equation*}
\end{oproblem}
Our second main problems, is wheter the previews is affermitive when restracting to finate gateset, that is, we ask 
\begin{oproblem}{The Main Open Problem.}
  Let $G$ be a finate universal two qubits gateset. Is there exsits a finate universal set  $G^{\prime}$ such: 
\begin{equation*}
  \begin{split}
