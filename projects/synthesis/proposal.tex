...
Gadgets.
 ...
 \begin{equation*}
   \begin{split}
     \prb{|\bar{J}| \ge \gamma n | \DD \text{ never fails } } & \le  \prb{|\bar{J}| \ge \gamma n \ | \ \DD \text{ never fails } , |\bar{I}| \le \beta n } \cdot \prb{\DD \text{ never fails } , |\bar{I}| \le \beta n}  \\
     & + \prb{|\bar{J}| \ge \gamma n \ | \ |\bar{I}| \ge \beta n } \cdot  \prb{|\bar{I}| \ge \beta n} \\ 
     &\le  p^{\beta n} =o(1) + (p^\frac{\beta}{\gamma})^{\gamma n}
   \end{split}
 \end{equation*}
