...
\cite{ newman2017limitationstransversalcomputationquantum}
  ...
  Since we know that classical computation in the presence of noise can be computed at constant overhead at depth and in pariticular Noise-$\NC = \NC$ ,it's attempting to conclude that in this scenario $\NC \neq \QNC$. 
