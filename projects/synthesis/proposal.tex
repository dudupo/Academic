...
%\end{quantikz}
  ...
  \cite{ bostanci2021findingdisjointnessstabilizercodes} 
...
For example, the disjointness of the classical repitition  code, the $X$-type generator is $X^{\otimes n}$, the $Z$-type generator is $Z \otimes I^{\otimes n-1}$. 

\begin{enumerate}
  \item Disjointness of 2D toric code. 
  \item Disjointness of classical repition code. 
  \item Disjointness of the good quantum LDPC code. 
\end{enumerate}
