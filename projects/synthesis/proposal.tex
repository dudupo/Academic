...
%slice style=blue,slice label style={inner sep=1pt,anchor=south west,rotate=40}
  ...
  \begin{figure}[h]
    ...
    \begin{quantikz}[slice style=blue,slice label style={inner sep=1pt,anchor=south west,rotate=40}]
      \lstick{$q_1$} & \qw & \qw & \qw &    & \gate[wires=9][1.7cm]{U} \slice[style=blue, label style={inner sep=1pt,anchor=south west,rotate=40}]{slice 1}  & \gate[wires=9][1.7cm]{ F }  & \gate{\mathcal{N}}  & \qw & \\
