...
\begin{openproblem}
Consider a circuit over $n$ classical (quantum) bits. What are the domains of depth $d$ and width $w$ for which the circuit can be fault-toleraized at the cost of $w$ and $d$ width and depth overheads?
\end{openproblem}
\inb{
}
