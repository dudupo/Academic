...
\end{definition}
It was shown in \cite{newman2017limitationstransversalcomputationquantum} that any binary code which is not a maximally result code cannot compute the Toffoli transversally; otherwise, it implies the existence of a relatively low-resource consuming homomorphic protocol which violates Nayak's bound \cite{nayak1999optimallowerboundsquantum}.
