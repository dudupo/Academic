...
Gadgets.
 ...
 \begin{equation*}
   \begin{split}
     \prb{|\bar{J}| \ge \gamma n } & \le  \prb{|\bar{J}| \ge \gamma n | \DD \text{fails} , |\bar{I}| \le \beta n } \prb{\DD \text{fails} , |\bar{I}| \le \beta n}  + \prb{|\bar{J}| \ge \gamma n , |\bar{I}| \ge \beta n } \prb{|\bar{I}| \ge \beta n} \\ 
     &\le o(1) + p^{\beta n} =o(1) + (p^\frac{\beta}{\gamma})^{\gamma n}
   \end{split}
 \end{equation*}
