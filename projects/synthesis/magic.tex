...
\begin{equation*}
    ...
    \begin{equation*}
      \begin{split}
        \prb{\bigcup_{\substack{ |S| < \alphan^{\frac{1}{3}} \\ |T| < \beta |S|  }}}  & \le \sum_{\substack{ |S| < \alphan^{\frac{1}{3}} \\ |T| < \beta |S|  }}{ \prb{X_{S,T}}  } \\
          & \le \sum_{k}^{\alphan^{\frac{1}{3}}}{  { n \choose k  }{ \gamma n^{\frac{1}{3}} \choose \beta k  }\cdot \left( \frac{2\beta kd_{2}}{ nd_{1}  } \right)^{kd_{1}} \\ 
