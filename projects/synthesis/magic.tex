...
\begin{equation*}
  \begin{split}
    \prod_{g \in \Lambda} \left( I +  T_{g}X_{g} \right) \ket{C_{Z}^{\perp}} &=  M_{1}^{\dagger} T^{n} \ \ \prod_{g \in \Lambda} \left( I +  X_{g} \right)  E \ \ L[M_{2}^{\dagger}] \ \ \prod_{g \in C_{Z}^{\perp}} \left( I +  X_{g} \right) \ket{L[g]}  
  \end{split}
\end{equation*}
