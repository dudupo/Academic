...
% vertices
%\foreach \i in {1,...,5}
%    \node[circle, fill=black, inner sep=1.5pt] (\i) at (72*\i:1.5) {}
%    \foreach \j in {1,...,4}
%    \node[circle, fill=black, inner sep=1.5pt] (5*\i+\j) at ( 18*(5*\i+\j):3) {};
...
\foreach \i in {1,...,5}
    \foreach \j in {1,...,4}
    \node[circle, fill=black, inner sep=1.5pt] (5*\i+\j) at (72*\i+18*\j:3) {};
\node[circle, fill=black, inner sep=1.5pt] (0) at (0,0) {};
% edges
\foreach \i in {1,...,5}
        \draw (\i) -- (0);
% labels
\foreach \i in {1,...,5}
    \node[above] at (72*\i:1.5) {\i};
\foreach \i in {1,...,5}
    \foreach \j in {1,...,4}
    \node[above] at (72*\i+18*\j:3) {5*\i+\j};
