...
So eventually we have a product of gates when non Clifford gates are applied on only generator of $C_{Z}^{\perp}$.

\begin{equation*}
  \begin{split}
     \prod_{g \in \Lambda} T_{g} \ \ \prod_{g \in \Lambda, h} \{ CZ_{g,h} | I \} \ \ \prod_{g ,h \in C_{z}^{\perp}} \{ CS_{g,h} | CZ_{g,h} | I \} \ \ \prod_{g ,h, l \in C_{z}^{\perp}} \{ CCZ_{g,h,l} | I \} \ket{f}
  \end{split}
\end{equation*}
