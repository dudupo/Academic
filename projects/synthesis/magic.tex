...
$C^\perp$ is the dual code for $C$, namely the code defined such any codeword of it $z\in C^\perp$ is orthogonal to any $x\in C$, $z\cdot x = 1$. $C^{\top}$ stands for the code obtained by taking the parity check matrix of $C$ and transporting it.   
