...
\begin{claim}[Not Formal]
  ...
  \begin{proof}
    \ctt{ 
      We will do it by iterating the generators of $C$ after performing row reduction to the generator matrix. Now we will concatenate the $i$ coordinate to complete the weight of the $i$th row to satisfy the requirements. 
    } 
  \end{proof}
