...
\begin{equation*}
  \begin{split}
    \prb{Y_{u,v}} &=  1 - \frac{ n \left( n - 1 \right)\cdot\cdot\cdot\left( n - d_{2}  \right)   }{ nd_{1} \cdot \left( nd_{1} - 1 \right) \cdot\cdot\cdot \left( nd_{1} - d_{2} \right)  }\cdot \left( d_{1} \right)^{d_{2}} \\ 
    &=  1 - \frac{ nd_{1} \left( nd_{1} - d_{1} \right)\cdot\cdot\cdot\left( nd_{1} - d_{1} d_{2} \right)   }{ nd_{1} \cdot \left( nd_{1} - 1 \right) \cdot\cdot\cdot \left( nd_{1} - d_{2} \right)  } \le 1 - \left( \frac{1}{2} \right)^{d_{2}} 
  \end{split}
\end{equation*}
