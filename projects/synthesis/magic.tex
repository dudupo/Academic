...
\begin{claim}
 Let $\varepsilon > 0$ and any code $C$ at rate $\rho(C) \ge 7/8 + \varepsilon$ has at least $\varepsilon 2^{n}$ codewords, such that any of them has a remainder of $1$ when divided by $8$. 
\end{claim}
...
\begin{claim}
  ...
  \begin{enumerate}
    ...
    \item There exists $\varepsilon$ generators $g$ such that $|g| = 8k+1$
  \end{enumerate}
\end{claim}
