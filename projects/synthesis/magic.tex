...
In this paper, we are define the triple product $\mathbb{F}_2^{n}\times \mathbb{F}_2^{n}\times\mathbb{F}_2^{n} \rightarrow \mathbb{Z}$ to be $x\cdot y \cdot z = \sum_{i}^{n}{x_{i}y_{i}z_{i}}$.
