...
\begin{claim}
  There exists family of quantum codes $Q$ such the codes $\sMbas$ chosen respect to them has a positive rate. Furthermore, the rate of $\sMbas$ is a asymptotically converge to $Q$ rate:
  \begin{equation*}
    \begin{split}
