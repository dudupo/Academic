...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item Assumption. Assume the correctness of the claim for every $c-1$.   
    \item Step. Denote by $B_{j}(\Delta)$ the bucket $\Delta\cdot j +1,  \Delta\cdot j +2, .. \Delta \cdot (j+1)-1$. 
      \begin{equation*}
        \begin{split}
