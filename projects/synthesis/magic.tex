...
\begin{proof}
  ...
  &= |x_{0}|_{w\cap x_{0}} + |y|_{w\cap x_{0}} +|z|_{w\cap x_{0}} - 2| x \cdot y |_{w\cap x_{0}} - 2| x \cdot z |_{w\cap x_{0}} -2| z \cdot y |_{w\cap x_{0}} + |x_{0}\cdot y \cdot z|_{w\cap x_{0}}  \\
  &= |x_{0}|_{w\cap x_{0}} + |y|_{w\cap x_{0}} +|z|_{w\cap x_{0}} - 2| x \cdot y |_{w\cap x_{0}} - 2| x \cdot z |_{w\cap x_{0}} -2| z \cdot y |_{w\cap x_{0}} + |y \cdot z|_{w\cap x_{0}}  
    \end{split}
  \end{equation*}
