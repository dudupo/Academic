...
\begin{equation*}
  \begin{split}
    \prb{Y_{u,v} = 0  | N(v)} & \ge \frac{ \left( n - d_{2} \right) \left( n - d_{2} - 1 \right)\cdot\cdot\cdot\left( n - 2d_{2}  \right)   }{ nd_{1} \cdot \left( nd_{1} - 1 \right) \cdot\cdot\cdot \left( nd_{1} - d_{2} \right)  }\cdot \left( d_{1} \right)^{d_{2}} \\ 
  \end{split}
\end{equation*}
