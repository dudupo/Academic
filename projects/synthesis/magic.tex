...
\begin{claim}
  We can  repeat on \Cref{claim:commute}, but flipping the bit such that the majority of pairs and triple multiplication is zero. And then in the end we will have the inequality:
  \begin{equation*}
    \begin{split}
