...
\begin{proof}
  ...
  \begin{align*}
          ...
          \text{CNOT} & \ \sum_{v \in V^{+}}\ket{z_{v}} \otimes \sum_{u\in V^{-}}{\ket{z_{u}}} & \mapsto  \\ 
       I \otimes D & \ \sum_{\substack{v \in V^{+} \\ u \in V^{-}}}\ket{z_{v} + z_{u}} {\ket{z_{u}}} & \mapsto  \\
            &  \ \sum_{\substack{v \in V^{+} \\ u \in V^{-}}}\ket{z_{v} + z_{u}}\ket{0} & 
    \end{align*}
\end{proof}
