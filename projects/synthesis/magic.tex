...
\begin{proof}
The rates of both $C_{X}/C_{Z}^{\perp}$ and $C_{Z}^{\perp}/C_{X}^{\perp}$ are $(2\rho-1)^{2}$, which is close to one as desired. Therefore, the intersection of those subspaces cannot vanish.
\end{proof}
