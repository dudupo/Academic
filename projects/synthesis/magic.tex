...
\begin{equation*}
  \begin{split}
    \right( H_{X} \otimes I \left) CX_{n\rightarrow n} \left(E \otimes E \right)\ \ I \otimes L[M_{2}^{\dagger}] \ \ \prod_{J\in \{\Lambda,C_{Z}^{\perp} \}} \prod_{g \in J} \left( I +  X_{L[g]} \right) \ket{0}  
  \end{split}
\end{equation*}
