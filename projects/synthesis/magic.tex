...
$x $ So the punctured $d$-dgree polynomial code is orthogonal for the punctured $n-1-d$ polyonimal code. So we can take $d = q/2 - 1$, and $\Delta = \alpha q$ to have $[\alpha q, q/2 -1, q/2 - (1-\alpha)q]$ code.   
