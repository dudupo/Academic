...
\Rightarrow & |S| < k^{\prime} - \frac{k^{\prime 3}}{24k^{2}} <k - \frac{k^{\prime 2} k}{24k^{2}} 
    \end{split}
  \end{equation*}

  Therefore, if $k^{\prime} \ge  \alpha k$ we have that $|S| < (1 -\frac{1}{24})k$ implies that $\dim \Lambda^{\prime} \ge \left( \alpha - \frac{23}{24} \right)k$.  
