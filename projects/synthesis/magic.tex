...
\begin{proof}
  ...
  For any $v \in V$ denote by $\ket{z_{v}}$ the superposition of $C_{0}$ codewords supported by $v$ local view, and for any subset of vertices $W \subset V$ denote by $\ket{z_{W}} = \ket{\sum_{v \in W} z_{v}}$ . Thus the computation sum up into:  
