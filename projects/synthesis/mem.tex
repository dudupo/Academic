  ...
  \begin{equation*}
    \begin{split}
      \prb{ \text{  Any (qu)bit of }  S \text{ sees } \mu \text{-majority } } & \le \sum_{i = (\frac{1}{2} - \mu ) |Q|}{{|Q| \choose  i }  \prb{ i \text{ checks are satisfied } } } \\ 
        & \le  \sum_{i = (\frac{1}{2} - \mu ) |Q|} {   {|Q| \choose  i }   \prod_{\text{checks}} \prb{ X_{c} \ge 1 }   } \\ 
        & \le  \sum_{i = (\frac{1}{2} - \mu ) |Q|} {   {|Q| \choose  i }  \prod_{\text{checks} \exp{ X_{c} }   }} \\  
        ...
        & =  q^{  1 + \log_{q}{\Delta_{2} -1 }  (\frac{1}{2} - \mu ) |Q| + \log_{q}{2} |Q|   } \frac{\frac{1}{2}}{\frac{1}{2} - \mu} \\
        & =   \left( q^{  1 + \log_{q}{\Delta_{2} -1 }  (\frac{1}{2} - \mu ) + \log_{q}{2}    } \right)^{|Q|}  \frac{\frac{1}{2}}{\frac{1}{2} - \mu} 
    \end{split}
  \end{equation*}
\end{proof}
