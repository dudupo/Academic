...
\begin{enumerate}
  ...
  \item Denote by $S$ the support of an error occurred on $\rho$ (S is a random variable). Then, with high probability, $|S_{c_{1}}| > \frac{1}{4} |S_{1}|$.
\end{enumerate}


\begin{claim}
  Given density $\rho$ such that (1) and (2) when conditing on   
\end{claim}
