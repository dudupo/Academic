...
However that is impossible, what we can require is to have the above inequality for $\omega \in \Omega_{\varepsilon}$ where $\Omega_{\varepsilon}$ is the errors configurations. 
