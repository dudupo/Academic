...
\begin{equation*}
  \begin{split}
    \prb{S \subset E_{2}} \le \prb{\text{any bit } v\in S_{c_{1}} \text{ sees majority of unstatisfied stabilizers   } } \le q^{\Delta |S|_{c_{1}}}
  \end{split}
\end{equation*}

\begin{equation*}
  \begin{split}
    \prb{S \subset E_{3} } &= \sum_{S^{\prime} \subset S}\prb{S^{\prime} \subset E_{2} \cap S/S^{\prime} \in E_{3}/E_{2} }\\ 
