...
\begin{enumerate}
  ...
  \item Denote by $S$ the support of an error occurring on $\rho$ (S is a random variable). Then, with high probability\footnote{I'm leaving specifying what it is to later.}, $|S_{c_{1}}| > \frac{1}{4} |S|$. ( \ctt{ See the comment in blue below, it gets complicated.} )
\end{enumerate}
...
\begin{equation*}
  \begin{split}
    \prb{ \Su{} \left(E_{3}\right) = S   } &= \sum_{S^{\prime} \subset S}\prb{  \Su{} \left( E_{2} \right) = S^{\prime}  \cap \Su{} \left( E_{3}/E_{2}\right) = S/S^{\prime}  \Big{|}  |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|  }\\ 
    & + \prb{  | \Su{} \left( E_{2} \right)_{c_1} | < \frac{1}{4} | \Su{} \left( E_{2} \right)_{c_1} |} \\
    %& \le \sum_{S^{\prime} \subset S }{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}|}  } \\
    & = \sum_{S^{\prime} \subset S \text{ and }  |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|}{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}|} } +  \prb{  | \Su{} \left( E_{2} \right)_{c_1} | < \frac{1}{4} | \Su{} \left( E_{2} \right)_{c_1} |} \\
    & \le \sum_{S^{\prime} \subset S }{q^{\Delta \frac{1}{4}|S^{\prime}|}p^{|S /S^{\prime}|}  } +  \prb{  | \Su{} \left( E_{2} \right)_{c_1} | < \frac{1}{4} | \Su{} \left( E_{2} \right)_{c_1} |} \\
    &\le \left( q^{\frac{1}{4}\Delta} + p \right)^{|S|}  + \prb{  | \Su{} \left( E_{2} \right)_{c_1} | < \frac{1}{4} | \Su{} \left( E_{2} \right)_{c_1} |} 
    %\sum_{S^{\prime} \subset S \text{ and }  |S^{\prime}_{c_1}| < \frac{1}{4} |S^{\prime}|}{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}|}  }
  \end{split}
\end{equation*}
...
\ctt{Observes that for $\prb{ |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|} $ being low, we might want the colorization $c_{1}$ to be made at random. Otherwise, $S$ could be picked such that $S_{c_1} = \emptyset$ and therefore for any subset $S^{\prime} \subset S$ it would also hold that $S^{\prime}_{c_1} = \emptyset$.}
