...
\begin{equation*}
  \begin{split}
    ...
    & \le \sum_{S^{\prime} \subset S }{q^{\frac{1}{2}\Delta|S^{\prime}|_{c_{1}}}p^{|S /S^{\prime}|}  }  %+  \prb{  | \Su{} \left( E_{2} \right)_{c_1} | < \frac{1}{4} | \Su{} \left( E_{2} \right) |} \\
...
\begin{equation*}
  \begin{split}
    \prb{ \Su{} \left(E_{3}\right) = S   } & \le  \le \sum_{S^{\prime} \subset S }{q^{\frac{1}{2}\Delta|S^{\prime}| / k }p^{|S /S^{\prime}|}  } \\
    &\le \left( q^{\frac{1}{2k}\Delta} + p \right)^{|S|}  
  \end{split}
\end{equation*}
