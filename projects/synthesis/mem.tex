...
\begin{equation*}
  \begin{split}
    \Pt_{t+1} \le \prb{ |S^{t}_{c_{1}}| > \frac{1}{4}|S_{t}| \text{ and }  | \left( S_{t+1}/S_{t} \right)_{c_1}  | \ge \frac{1}{4}|S_{t+1}/S_{t}|  } \le \Pt \cdot \left( 1 - e^{- \varepsilon} m  \right) \le \Pt_{0}( 1 - (t+1) e^{- \varepsilon m } 
  \end{split}
\end{equation*}<++>
