...
\begin{proof}
  ...
  \begin{equation*}
    \begin{split}
      |Y| &= \frac{\Delta-1}\sum_{i}^{h/2} E\left( T^{2i + 1} \right) =  \frac{\Delta-1}\sum_{i}^{h/2} \frac{1}{2} \left( E\left( T^{2i + 1} \right)+ E\left( T^{2i + 1} \right) \right) \\  
      & \ge \frac{\Delta-1}\sum_{i}^{h/2} \frac{1}{2} \frac{1}{\Delta} \left( E\left( T^{2i + 1} \right)+ E\left( T^{2i} \right) \right) = \frac{1}{2 \left( \Delta - 1 \right) \Delta }|T| \\ 
      & \ge \frac{1}{2 \left( \Delta - 1 \right) \Delta } \frac{1}{\Delta}|E| 
    \end{split}
  \end{equation*}
\end{proof}
