...
\begin{equation*}
  \begin{split}
    \prb{ \Su E_{2} = S } \le \prb{\text{any bit } v\in S_{c_{1}} \text{ sees majority of unstatisfied stabilizers   } } \le q^{\Delta |S|_{c_{1}}}
  \end{split}
\end{equation*}

\begin{equation*}
  \begin{split}
    \prb{ \Su E_{3} = S   } &= \sum_{S^{\prime} \subset S}\prb{ E_{2} \Su S^{\prime}  \cap E_{3}/E_{2} \Su S/S^{\prime}   }\\ 
...
Let $S^{t} = \Su E $ at time $t$ and denote by $\Pt_{t}$ the probability that $|S^{t}_{c_{1}}| > \frac{1}{4}|S_{t}|$.
