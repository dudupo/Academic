...
\begin{equation*}
  \begin{split}
    ...
    & \le \sum_{S^{\prime} \subset S }{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}_{c_1}|}  } \le \sum_{l}\sum_{S^{\prime} \subset S : |S^{\prime}_{c_1}|=l }{q^{\Delta |S^{\prime}_{c_1}|}p^{|S_{c_1}| - |S^\prime_{c_1}|}  } \\
