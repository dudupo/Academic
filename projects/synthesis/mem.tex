...
\begin{equation*}
  \begin{split}
    ...
    & \le \sum_{S^{\prime} \subset S }{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}_{c_1}|}  } \\
    & = \sum_{S^{\prime} \subset S \text{ and }  |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|}{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}_{c_1}|}  } + \sum_{S^{\prime} \subset S \text{ and }  |S^{\prime}_{c_1}| < \frac{1}{4} |S^{\prime}|}{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}_{c_1}|}  }\\
    & \le \sum_{S^{\prime} \subset S \text{ and }  |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|}{q^{\Delta |S^{\prime}_{c_1}|}p^{|S /S^{\prime}_{c_1}|}  } + \prb{ |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|} \cdot 1 \\ 
    & \le \sum_{S^{\prime} \subset S \text{ and }  |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|}{q^{\Delta \frac{1}{4}|S^{\prime}|}p^{|S /S^{\prime}|}  } + \prb{ |S^{\prime}_{c_1}| \ge \frac{1}{4} |S^{\prime}|} \cdot 1 \\ 
    &= \sum_{l}\sum_{S^{\prime} \subset S : |S^{\prime}_{c_1}|=l }{q^{\Delta |S^{\prime}_{c_1}|}p^{|S_{c_1}| - |S^\prime_{c_1}|} p^{|S_{/c_{1}}|-|S^{\prime}_{/c_{1}}|}  } \\
    & = \sum_{l}\sum_{S^{\prime} \subset S : |S^{\prime}_{c_1}|=l }{q^{\Delta |S^{\prime}_{c_1}|}p^{|S_{c_1}| - |S^\prime_{c_1}|} p^{|S_{/c_{1}}|-|S^{\prime}_{/c_{1}}|}  } \\
