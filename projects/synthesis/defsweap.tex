...
For brevity, we name the first and second coordinates in the result of $\psi_{R}$ the \textit{register coordinate} and the \textit{inner coordinate}.
    ...
    \begin{definition}[Troic Encoded Circuit]
      ...
      \begin{enumerate}
        ...
        \end{enumerate} 
        For a set of faults $\mathcal{E}$ the gates in $C[\mathcal{E}]$ can be decomposed to cycles, of the following form $\Lambda, P, D$.  
