        ...
        \begin{equation*}
          \begin{split}
            E_{o} \colonequals \big\{ \{(v,t), (u,t^{\prime}) \} : &  \text{ if }     \\ 
              \text{either} &  \text{there exists } i \text{ such }  \{v,u\} \in \mathcal{G}_{i} \text{ and } t^{\prime} = t,t+1 \\
            \text{or} &  \text{there exists } u_i = (g_{i},l_{i}) \text{ such }  v,u \in l_{i,2} \text{ and } t = l_{i,1}, t^{\prime} = l_{i,1}+1 t \\big\} 
          \end{split}
        \end{equation*}
    \end{enumerate} 
  \end{definition}
