...
The main advantage of using the dual-tensor and \Hyp is that their bases can be easily understood in terms of the codes used in the construction, for the dual-tensor $(C^{\perp}\otimes C^{\perp})^{\perp}$ 
