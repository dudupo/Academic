   ...
   \begin{enumerate}
     \item Moving forward with the experiential work? 
       \begin{itemize}
         ...
         \item Accelerate, the decoder. Parallelize it with GPUs/FPGA? Do we have budget? Publishing the source as library? 
     ...
     \item Moving to the next stage, can we do it by December?
   \end{enumerate}
