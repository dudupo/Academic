...
\begin{block}{Alg.}
  We define a north vector $\mathbf{1} = (1,1,1..1)$, Then each \textbf{vertex} looks only at the \textbf{cells} on its neighbourhood such that they are positive relative to $\mathbf{1}$.
