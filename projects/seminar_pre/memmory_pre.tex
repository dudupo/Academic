...
\begin{block}{Today:}
\begin{itemize}
  \item Recap, and were we stood before the summer.  
...
\begin{frame}
  ...
  \begin{tikzpicture}
    \node[align=center] (v1) at (0,1) { Coming with $O(1)$-depth\\
    gates for 'good' codes. };
    \node (v2) at (3,2) { Is the $(d,k)$-Toric a MEM?  };
      \node (v3) at (6,3) { Dennis at el? };
      \node (v4) at (7,4) { Perskil and Swift Rule? };
      \node (v5) at (7,5) { Simulations };
