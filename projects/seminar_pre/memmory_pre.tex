...
\begin{frame}
  ...
  \begin{tikzpicture}
    \node[align=center] (v1) at (0,5) { Coming with $O(1)$-depth\\
    gates for 'good' codes is hard. };
    \node (v2) at (0,4) { Is the $(d,k)$-Toric a MEM?  };
    \node (v3) at (0,3) { Dennis at el? \Cref{Dennis_2002} };
    \node (v4) at (0,2) { Swift-Rule? \Cref{Kubica_2019} };
      \node (v5) at (0,1) { Simulations };
