...
{\includesvg[width=0.5\textwidth]{../synthesis/colorized_c_x/test_colorized_c_0.svg}};
\node[inner sep=0pt] (color_1) at (4,0)
{\includesvg[width=0.5\textwidth]{../synthesis/colorized_c_x/test_colorized_c_1.svg}};
\node[inner sep=0pt] (color_2) at (8,0)
{\includesvg[width=0.5\textwidth]{../synthesis/colorized_c_x/test_colorized_c_2.svg}};
\node[inner sep=0pt] (color_3) at (12,0)
{\includesvg[width=0.5\textwidth]{../synthesis/colorized_c_x/test_colorized_c_3.svg}};
  \end{tikzpicture}
  \end{frame}
