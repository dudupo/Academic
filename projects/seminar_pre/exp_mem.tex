...
\begin{frame}
  ...
  \begin{align*}
    \exppm{f}{\sim q^{(t)} } &=  \exppm{ \expp{ f \circ D }{\sim p}  }{\sim q^{(t-1)} } \le   \exppm{ \expp{ f \circ D }{\sim p}  }{\sim p } + (t-1)| \exppm{f \circ D}{p}   | e^{- c \sqrt{n} } \\
      & \le \exppm{ f }{ \sim p  } + t|f| e^{- \Theta( \sqrt{n}) }
  \end{align*}
\end{frame}
