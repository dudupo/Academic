...
\begin{frame}
  ...
  \begin{block}{Claim}
    Consider the application of a $2p(1-p)$-depolarizing channel. Let $S$ be a subset of qubits chosen uniformly random \footnote{each qubit is taken with probability $\frac{1}{2}$}, then the probability that there are more than $\frac{1}{100}$ dependent qubits in $S$ is less than $e^{-c\sqrt{n}}$.
  \end{block}
  ...
  \begin{block}{Proof}
    ...
    \begin{align*}
      ...
      & \le \exppm{  |J|  }{ \sim 2p(1-p) } = 2p(1-p) \Delta^{l} |S| 
    \end{align*}
    ...
    \begin{align*}
      ...
      & \le \exppm{  |J|^{\prime}  }{ \sim 2p(1-p) }  = \frac{1 - ( 1-2p)^{\Delta_{2}} }{2} \Delta^{l} |S| 
    \end{align*}
  \end{block}
\end{frame}
