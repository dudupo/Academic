...
\begin{frame}
  ...
  \begin{block}{Claim}
  Consider application of $2p(1-p)$-depolarized channel, followed by decoding $D$. For any subset of qubits $S$, the probability that there are more than $\frac{1}{100}$ dependents qubits in $S$ is less than $e^{-c\sqrt{n}}$. 
  \end{block}
