...
\begin{frame}
  ...
  \begin{block}{Claim}
Consider the application of a $2p(1-p)$-depolarizing channel, followed by decoding $D$. For any subset of qubits $S$, the probability that there are more than $\frac{1}{100}$ dependent qubits in $S$ is less than $e^{-c\sqrt{n}}$.
  \end{block}
...
\begin{frame}
  ...
  Denote by $S$ the subset of the flipped qubits, and denote by $In(S)$ the number of dependent qubits in $S$. 
  \begin{align*}
    & \exppm{ f \circ D }{\sim 2p(1-p) } =  \sum{ f\circ D (S)  \cdot \prb{S} } \\ 
    & \le \sum_{|S| \ge \alpha n }{ f\circ D (S)  \cdot \prb{S } }  + |f|e^{-c\sqrt{n}} \\
  & \le \sum_{|S| \ge \alpha n, Id(S) < \frac{1}{100}|S|  }{ f\circ D (S)  \cdot \prb{S } } + |f| e^{-c\sqrt{n}} + |f|e^{-c\sqrt{n}} \\
  & \le \sum_{|S| \ge \alpha n, Id(S) < \frac{1}{100}|S|  }{ f (S) M(2p(1-p))^{\frac{99}{100}|S|}  } + |f| e^{-c\sqrt{n}} + |f|e^{-c\sqrt{n}}
  \end{align*}
\end{frame}
...
\begin{frame}
  \frametitle{Lemma Proof}
  \begin{align*}
  & \le \sum_{|S| \ge \alpha n, Id(S) < \frac{1}{100}|S|  }{ f (S) p^{|S|} } + |f| e^{-c\sqrt{n}} + |f|e^{-c\sqrt{n}}\\
  & \le \sum_{ S }{ f (S) p^{|S|} } + |f| e^{-c\sqrt{n}} + |f|e^{-c\sqrt{n}}\\
  & \le \exppm{ f (S) }{\sim p } + |f| e^{-c\sqrt{n}} + |f|e^{-c\sqrt{n}}
\end{align*}
\end{frame}
