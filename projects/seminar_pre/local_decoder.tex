...
\begin{frame}
  \frametitle{Storing Logical State - Classical Statement}
...
\begin{frame}  
  \frametitle{The Theorem - Classical Statement} 
...
\begin{frame}
  \frametitle{Storing Logical State - Quantum Statement}
...
\begin{frame}  
  \frametitle{The Theorem - Quantum Statement} 
  \begin{block}{Theorem} There is $p_{\text{th}} \in (0,1)$ such that for any $p < p_{\text{th}}$ and any bounded Hermitian operator $X$ we have: 
    \begin{equation*}
...
\begin{frame}
  ...
  \begin{align*}
    & \Tr \left( I - X \right) \rho^{(t)} \le \Tr  \left( I - X \right)  \mathcal{N}_{p} \left( \rho \right)  + t||I - X|| e^{- \Theta( \sqrt{n}) } \\ 
  \Leftrightarrow  & \Tr X\rho^{(t)} \ge \Tr X  \mathcal{N}_{p} \left( \rho \right)  - t||I - X|| e^{- \Theta( \sqrt{n}) }
  \end{align*}

\end{frame}

\begin{frame}
  \frametitle{Corollary II}

  \begin{align*}
    & \Tr  X I D \mathcal{N}_{p} I D \mathcal{N}_{p}I D \mathcal{N}_{p} .. I D \mathcal{N}_{p} \hat{U} D \mathcal{N}_{p} I D \mathcal{N}_{p} .. I D \mathcal{N}_{p}\rho  \\ 
    & \le \Tr  X I D \mathcal{N}_{p} I D \mathcal{N}_{p}I D \mathcal{N}_{p} .. I D \mathcal{N}_{p} \hat{U} \mathcal{N}_{p}\rho  + e^{-\sqrt{n}} t_{1}  \\
    & \le \Tr  X I D \mathcal{N}_{p} I D \mathcal{N}_{p}I D \mathcal{N}_{p} .. I D \mathcal{N}_{p} \left( \hat{U} + [\hat{U} ,\mathcal{N}_{p}] \right) \rho  + e^{-\sqrt{n}} t_{1}  \\ 
    & = \Tr  X I D \mathcal{N}_{p} I D \mathcal{N}_{p}I D \mathcal{N}_{p} .. I D \mathcal{N}_{p} \rho_{2} \\
    & \ \ \ +  \Tr  X I D \mathcal{N}_{p} I D \mathcal{N}_{p}I D \mathcal{N}_{p} .. I D \mathcal{N}_{p} [\hat{U} ,\mathcal{N}_{p}]  \rho+ e^{-\sqrt{n}} t_{1}  \\ 
    & = \Tr  X \mathcal{N}_{p} \rho_{2}  + e^{-\sqrt{n}} \left( t_{2} - t_{1} \right) + e^{-\sqrt{n}} t_{1}  \\ 
 & \ \ \ + \Tr  X I D \mathcal{N}_{p} I D \mathcal{N}_{p}I D \mathcal{N}_{p} .. I D \mathcal{N}_{p} [\hat{U} ,\mathcal{N}_{p}] \\
  \end{align*}

\end{frame}

\begin{frame}
  \frametitle{Corollary III}
If the gate has $\tau$-depth, then in the argument about the concentration of dependent bits, changing one coordinate contributes at most a $2^{\tau}$ factor to the dependence.
\end{frame}
