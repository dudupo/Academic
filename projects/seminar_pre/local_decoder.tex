...
\begin{frame}
  ...
  \begin{block}[Proof]
 If there are two qubits that share a check, then the decoder doesn't fail to 'correct' them, and therefore the probability that the decoder fail to 'correct' all the qubits in $S$ is $0$. So, assume that 
 \end{block}
\end{frame}
