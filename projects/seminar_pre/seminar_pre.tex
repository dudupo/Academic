...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
Hence for $|e|/n \le \beta =  \frac{1}{2}   - \sqrt{\frac{2\lambda^{2}}{\Delta}}$\footnote{Reminder for David!!! Explain why $\lambda^2/\Delta \ge 1 $, and to describe how to correct the proof.} it holds that $\Delta|T^{(1)}| \le \frac{1}{2}|e|$. 
