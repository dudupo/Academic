...
\begin{tikzpicture}
  ...
  \node (expectation) [draw, rectangle, below of=bit, yshift=-0.3cm] {Expected flips in block of length $n$: $pn$};
  \node (inequality) [draw, rectangle, below of=expectation, yshift=-0.3cm] {Inequality: $\eta (\beta + p) n \le \beta n$};
  \node (solution) [draw, rectangle, below of=inequality, yshift=-0.3cm] {Solution: $\beta \ge \frac{p}{1 - \eta}$};
