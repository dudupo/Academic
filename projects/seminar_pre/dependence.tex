...
\begin{align*}
  ...
  = &\frac{1}{C_{1}} \prbm{f - \exppm{f}{ \sim\mathcal{D}^{\prime} } > t + \exppm{f}{ \sim\mathcal{D}^{\prime} } -  \exppm{f}{ \sim\mathcal{D} } }{\sim\mathcal{D}^{\prime}} \\ 
\le &\frac{1}{C_{1}}\prbm{f - \exppm{f}{ \sim\mathcal{D}^{\prime} } > t - \frac{C_{2} - C_{1}}{C_{2}}\exppm{f}{ \sim\mathcal{D} }}{\sim\mathcal{D}^{\prime}} \\
\le &\frac{1}{C_{1}}\prbm{f - \exppm{f}{ \sim\mathcal{D}^{\prime} } > \frac{t}{2} }{\sim\mathcal{D}^{\prime}} 
\end{align*}
