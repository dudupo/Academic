 ...
 %  \end{equation*}
  ...
  \begin{equation*}
    \begin{split}
      ...
      =  & \max_{f \perp \mathbf{1}} { \sum_{v}\sum_{\tau \in S} \frac{f\left( g\tau g^{-1} v \right) f \left( v \right)  }{ f^{\top}f}} = \max_{f \perp \mathbf{1}} { \sum_{v , gSg^{-1}v}\frac{f\left( u \right) f \left( v \right)  }{ f^{\top}f}} \\  
