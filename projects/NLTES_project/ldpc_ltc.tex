...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
clearly $|E^{\prime}| =  \frac{1}{2} {|S| \choose 2} |V|$. \ctt{ We need to show expansion, One elgante way is first to pick $\squrt{\log n }$ elements and then show that they match to expansion generator set.}    
