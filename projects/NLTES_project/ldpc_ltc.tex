 ...
 %  \end{equation*}
  ...
  \begin{equation*}
    \begin{split}
      ...
      = & \max_{f \perp \mathbf{1}} { \sum_{gv}\sum_{\tau \in S}\frac{f\left( g \tau v \right) f \left( g v \right)  }{ f^{\top}f}} \\  = & \max_{f \perp \mathbf{1}} { \sum_{gv}\sum_{gSg^{-1}gv}\frac{f\left( gu \right) f \left( gv \right)  }{ f^{\top}f}} \\
