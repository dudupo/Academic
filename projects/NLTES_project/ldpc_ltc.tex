...
Consider the code $C$, which consists of all the words $x\in C$ such that $x|_{v} \in C_{\pm}$ for any $v \in V_{\pm}$.
\paragraph{Claim.} If $\rho_{-} + \rho_{+} > 1$ then the $C$ has positive rate, and relative distance. 
