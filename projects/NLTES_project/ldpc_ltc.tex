...
\begin{equation*}
  \begin{split}
    \left( \delta_{2} - \left( 1- \frac{1}{2}\delta_{ 1}  \right) \right)\Delta & \le \frac{E\left( S,S \right)}{|S|} \le \frac{n}{\Delta}|S|^2+ \lambda|S| \\
    |S| & \ge \left( \delta_{2} - \frac{1}{2}\delta_{1} - 1 - \frac{\Delta}{\lambda} \right)n 
  \end{split}
\end{equation*}
