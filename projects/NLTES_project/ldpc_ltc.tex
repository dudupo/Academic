...
\begin{equation*}
  \begin{split}
    w_{E/E^{\prime}}\left( x|_{U\cup U_{+1}} \right) & \ge \delta_{-}\Delta|U|+ \delta_{+}\Delta|U_{+1}|\\  & -w\left( E( U_{+1} ,U)  \right) - w \left( E( U, U_{-1}) \right) - w \left( E( U_{+1}, U_{+2} ) \right)  \ge \\ 
	& \delta_{-}\Delta|U|+ \delta_{+}\Delta|U_{+1}|\\  &   \frac{\Delta}{n}\left( |U||U_{-1}| + |U||U_{+1}| + |U_{+1}||U_{+2}| \right) - \\ &  \lambda \left(  \sqrt{|U||U_{-1}|} + \sqrt{|U||U_{+1}|} + \sqrt{|U_{+1}||U_{+2}|} \right)  
