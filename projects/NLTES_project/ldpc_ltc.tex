...
\begin{equation*}
  \begin{split}
    w_{E/E^{\prime}}\left( x \right) \ge \left( \delta_{0} - \frac{|U_{\max}|}{n} - 2\frac{\lambda}{\Delta} \right) \Delta|T| 
  \end{split}
\end{equation*}
...
\begin{equation*}
  ...
  \ge & \frac{\delta_{0}}{\Delta}|T|  - \sum{i \in [m]}{ E\left( U_{i}, U_{i+1}  \right)  } \\ 
  \ge & \frac{\delta_{0}}{\Delta}|T|  -  \sum{i \in [m]}{ \frac{\Delta}{n}|U_{i}| |U_{i+1}| + \lambda \sqrt{ |U_{i}| |U_{i+1}|i} }\\ 
  \ge & \frac{\delta_{0}}{\Delta}|T|  - \frac{\Delta}{n}|T||U_{\max}| - \lambda \sum_{i \in [m]} { \max{ |U_{i}| , |U_{i+1}| } \\ 
    \ge & \frac{\delta_{0}}{\Delta}|T|  - \frac{\Delta}{n}|T||U_{\max}| - \lambda \sum_{i \in [m]} {  |U_{i}| + |U_{i+1}| } \\ 
    \ge & \frac{\delta_{0}}{\Delta}|T|  - \frac{\Delta}{n}|T||U_{\max}| - 2 \lambda |T| \\ 
    \ge & \left( \delta_{0} - \frac{|U_{\max}| }{n}- 2 \frac{\lambda}{\Delta}<++> \right) \Delta|T| \\ 
  \end{split}
\end{equation*}
