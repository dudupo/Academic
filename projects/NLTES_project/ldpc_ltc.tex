...
And that immediately proves theorem 1, for any $\delta_{0} \ge \frac{2}{3} + \frac{2\lambda}{\Delta}$: 
\begin{equation*}
  \begin{split}
    |x| \ge  w_{E/E^{\prime}}\left( x|_{U} \right) \ge \left( \delta_{0} - \frac{2}{3} - \frac{2\lambda}{\Delta} \right)\frac{1}{2}n^{1-\varepsilon} \ \ \square 
  \end{split}
\end{equation*}
