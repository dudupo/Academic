...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
\paragraph{Claim.} $ |U||U_{-1}| + |U||U_{+1}| + |U_{+1}||U_{+2}| \le \left( |U| + |U_{+1}| \right)\frac{3}{4}n  $ 
\paragraph{Proof:} Recall that $ |U_{-1}| + |U_{+1}| =  |U_{-1} \cup U_{+1} | \le | V_{\pm} | = \frac{1}{2}n $. Then:  
\begin{equation*}
  \begin{split}
    & |U||U_{-1}| + |U||U_{+1}| + |U_{+1}||U_{+2}|  =  \frac{1}{2}\left( |U|(|U_{-1}| + |U_{+1}|) + |U_{+1}||U_{+2}|  \right) + \\ 
    &  \frac{1}{2}\left( |U||U_{-1}| + |U_{+1}|(|U| + |U_{+2}|)  \right) \le \\ 
    & \frac{1}{2}\left( |U_{-1}||U| + |U_{+1}||U_{+2}|  \right) + \frac{1}{2}n\left( |U| +|U_{+1}| \right) \\ 
    & \le \left( \frac{1}{4}n + \frac{1}{2}n \right) \left( |U| + |U_{+1}|  \right)  
  \end{split}
\end{equation*}
\begin{equation*}
  \begin{split}
    |U||U_{-1}| + |U||U_{+1}| + |U_{+1}||U_{+2}| \le   \frac{1}{2} \left(|U_{+1}|+|U_{1}|\right)|U_{-1}| + |U||U_{+1}| + |U_{+1}||U_{+2}| \le |U_{+1}|\left(  |U_{-1}| +   \right)
  \end{split}
\end{equation*}

\begin{equation*}
  \begin{split}
    |U \cup U_{+1}| & \ge |U \cup U_{-1} |, | U_{+2} \cup U_{+1} | \\  \Rightarrow & 
    |U| > |U_{+2}|, |U_{+1}| > |U_{-1}|  
  \end{split}
\end{equation*}
