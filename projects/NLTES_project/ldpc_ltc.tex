...
\begin{equation*}
  \begin{split}
    w_{E/E^{\prime}}  \left( x|_{U} \right)  & \ge \Delta\delta_{-}|U| - 2\Delta\frac{1}{8^{2}}\frac{|U|^{2}}{ n} - 2 \lambda \cdot \frac{8}{ \sqrt{\Delta} } |U| \\
    & \ge \left( \delta_{-} - \left( \frac{1}{8} \right)^{2} - \frac{1}{4}\lambda\frac{1}{\Delta} \right) \Delta |U|
  \end{split}
\end{equation*}
