...
\begin{equation*}
  \begin{split}
    \frac{1}{2}\lambda^{\prime} \le \frac{ \sum_{u\sim v }{ \left( x(u)-x(v) \right)^{2}  }}{\sum{x\left( v \right)^{2}}} \le \frac{\left( \beta+\alpha \right)^{2}\left( 1-\frac{1}{2}\delta_{1} \right)\Delta}{\left( \alpha-\beta \right)^{2} } \frac{|T|}{|S|} 
  \end{split}
\end{equation*}
\begin{equation*}
  \begin{split}
