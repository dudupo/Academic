...
\paragraph{Definition.}Let $L = \{L_{i}\}^{2|E|}_{0}$  be a series of $2|E|$. Such that each element $L_{i} \in C_{0}$. We will call $L$ the Potential list and refer to the $e_{v}$'th element of $L$ as a suggestion made by the vertex $v \in V$ for the edge $e \in E$. Notice that $\sum_{i}{L_{i}} \in C_{\oplus}$.
\paragraph{}
