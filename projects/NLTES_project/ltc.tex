...
\begin{multicols*}{2}
  ...
  \paragraph{The Construction.} Let $A_{1},A_{2},A_{3}$ be a different generators sets of $ \mathbf{GPL}(2 , \mathbb{Z} / \mathbb{qZ} )  $ 
  ...
  \begin{equation*}
    \begin{split}
  	 & Cay\left(  G, A_{1} \right)\times_{G} Cay\left(  G, A_{2} \right) \\
      	 & \bigcup Cay\left(  G, A_{1} \right)\times_{G} Cay\left(  G, A_{3} \right) 
    \end{split}
  \end{equation*}
