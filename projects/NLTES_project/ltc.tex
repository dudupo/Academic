...
\begin{multicols*}{2}
  ...
  \end{equation*}
   Then define the codes:
	...
	the small codes $C_{A_{j}}$, $\delta \Delta$ satisfy the equation $ \left(\Delta r\right)^{4}\left(1 - \color{red}2\delta\color{black}\right) < \frac{1}{2}\delta^{3} $ and also the code $ C_{A_{1}}  $ 
