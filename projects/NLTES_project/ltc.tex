...
\begin{multicols*}{2}
  ...
  \end{equation*}
   Then define the codes:
	...
	Then there exists a vertex $ g \in V_{0} $ and a local codeword $ c \in C_{A_1} \otimes C_{A_2} \otimes C_{A_3} $ supported entirly on the neighberhood of $ g $ such that: 
	$ |x + c| \le |x| $.
