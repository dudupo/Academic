...
\newcommand{ \Hw }{ \delta\Delta -\Delta^{\frac{1}{2}-\varepsilon}/\delta  }
 ...
 \begin{enumerate}
   \item Compute for every positive vertex the local view correspond to $\phi_{g}$. Call it, $\omega_{g}$.
   \item Sum the $\omega$'s divded by $\color{red}\frac{1}{3}\color{black}$. Namly $\sum_{g\in G}{\frac{1}{3}\omega_g}$.   
   \item Map the face values wich are fractions ( $\left\{ \frac{1}{3}, \frac{2}{3} \right\}$ ) to $1$ and to $0$ otherwise. Denote the word obtained by that by $J$.
 \end{enumerate}
