...
\begin{multicols*}{2}
 ...
 \end{enumerate}
 \paragraph{Proof Of Theorem 1} Let us call to the set of verices satisfy the constarints above \textbf{good vertices}. Pick any good vertex $g \in T$. Assume that we could find $ \eta, \xi  $ such that for $ |x| \le d $ we have that:
 \begin{equation*}
   \begin{split}
