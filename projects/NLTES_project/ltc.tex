...
\paragraph{Claim. Subcode Robusstness.} \textit{ Consider the subspaces $C^{A^{\prime}} \subset C^{A}, C^{B^{\prime}} \subset C^{B}$, such that the dual tensor of $C_{A}, C_{B}$ is $\omega$-robust then the dual tensor of $C_{A^{\prime}}, C_{B^{\prime}}$ is also $\omega$-robust.} 
