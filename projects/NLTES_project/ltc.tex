...
\begin{multicols*}{2}
  ...
  \end{equation*}
	...
	& \ge \left( 1 -   \left(\frac{\lambda^{\star}_{2}}{\xi - \left(2\Delta^{2} - \Delta  \right)\frac{|x|}{n \delta\Delta}}\right)^{2}\right) /  
      ...
      \end{split}
    \end{equation*}
    Let us call to the quantity above $\rho$ and denote by $1 - \tau$ the fraction of vertices of $ T $ with degree less then $\frac{1}{2}\bar{d}_{T} $. 
 Then $ \rho \le \bar{d}_{T} \le 3\Delta\tau + \left( 1 - \tau \right) \rho  $ 
 $ \Rightarrow \tau \ge \frac{\rho}{2\left( 3\Delta - \rho \right)} $	
