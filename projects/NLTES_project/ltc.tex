...
\begin{multicols*}{2}
 ...
 Assume that we could find $ \eta, \xi  $ such that for $ |x| \le d $ we have that:
 \begin{equation*}
   \begin{split}
     &  \eta \cdot  \frac{6}{\rho} \left( 9\Delta^{2} + \lambda^{\star}  \right) = \Theta\left( \Delta^{2\frac{1}{2}} \right)
   \end{split}
 \end{equation*}
\end{multicols*}
  % \printbibliography 
