...
\paragraph{Tasks.}
	...
	By the assumption that $C$ has maximal weight of $\tilde{\delta}$ we get that the contribuation of the second case is bounded by $\gamma\left( 1-\tilde{\delta} \right)\Delta^{2} $. 
