...
\newcommand{ \Hw }{ \delta\Delta -\Delta^{\frac{1}{2}-\varepsilon}/\delta  }
  ...
  For any $h \in \mathbb{Z}_{3}^{2} $ define the group $G^{h}$ to be: 
  \begin{equation*}
    G^{h} = \mathbf{PGL}  \times \left( h + \mathbb{Z}_{3}^{2}\cap \braket{ \left( 1,1 \right)} \right)
\end{equation*} 
  ...
  \begin{equation*}
    \begin{split}
      ...
      \Gamma_{\square_{1}}^{h} &= \left( G^{h}, \left\{ \left( \left(g, h_{1} \right),\left(  agb,h_{1} + \left( 1,1 \right)  \right)\right) : a \in A_{1}, b \in A_{2}  \right\}  \right) \\
      \Gamma_{\square_{2}}^{h} &= \left( G^{h}, \left\{ \left( g, agc \right) : a \in A_{1}, c \in A_{3} \right\}  \right) \\
      \Gamma_{\square \square} &= \left( G^{h}, \left\{ \left( g, gb, agc \right), \left( g, gc, agb \right) :
