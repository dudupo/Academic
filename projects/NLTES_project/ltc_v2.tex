  ...
  \end{equation*}
   Then define the codes:
	\begin{equation*}
	  ...
	  \end{split}
	\end{equation*}
	Notice that that $C_{x}$ could be viewed as the classical LTC code in Levarier and Zemor construction by treating the tensor product as standing alone small code. 
