...
\end{equation*} 
  ...
  \begin{equation*}
    \begin{split}
      ...
      \Gamma_{\square_{1}}^{h} &= \left[ G^{h}, \left\{ \left( \left(g, h_{1} \right),\left(  agb,h_{1} + \left( 1,1 \right)  \right)\right) : \right. \\ 
      & \left. a \in A_{1}, b \in A_{2}, h_{1} \in H^{h}  \right\}  \right] \\
