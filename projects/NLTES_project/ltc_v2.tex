...
\paragraph{Tasks.}
	...
	Remind that the dual tensor of $\Aabpp$ is spanned by the vectors $ \left\{ e_{i}\otimes v_{j} \right\} $ and $\left\{ u_{i}\otimes e_{j} \right\}$.  Let us write $x$ as formal sum of $\#_{A}$ 
