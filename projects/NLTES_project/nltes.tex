...
\begin{multicols*}{2}
  ...
  \paragraph{Claim} \textit{ for any ?  \left[ \left[ n,k,d \right] \right] CSS code property 1 holds }. 
\textbf{Proof.} let $y \in \{0,1\}^{n}$ be a vector such $ y \in \Gz $, let assume that $|y|_{c^{x^{\prep}}} \le C_{2} d$ then for any $ c \in C_{x}^{\prep}$: 
