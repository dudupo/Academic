...
\begin{proof}[Proof of Theorem 1+.] Notice that $\frac{1}{2} < \frac{2}{3} = q$, Thus repeating exactly over proof above obtains that: 
  \begin{equation*}
    ...
    \end{split}
  \end{equation*}
  When the last inequality follows form the fact that the proof of~\cref{claim:maxu} doesn't relay on graph structure arguments. The same arguments leads also to analog inequality for~\cref{claim:flu1}.
