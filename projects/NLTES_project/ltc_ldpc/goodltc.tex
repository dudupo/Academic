...
\begin{theorem} There exist a constant $\alpha > 0 $ and infinite family of codes which satisfies ~\cref{theorem:ltczerorate} and also good.
\end{theorem}
...
\begin{proof}[Proof of Theorem 1+.] Notice that $\frac{1}{2} < \frac{2}{3} = q$, Thus repeating exactly over proof above obtains that: 
  \begin{equation*}
    \begin{split}
