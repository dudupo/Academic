...
$ \left( 1 -d_{T}/2  \right)^{2}\Delta^{2} \le d_{T}\delta_{0}\Delta $


\begin{equation*}
  \begin{split}
    \left\{\frac{2 \Delta + 2 \delta_{0} - 2 \sqrt{2 \Delta \delta_{0} + \delta_{0}^{2}}}{\Delta}, \frac{2 \Delta + 2 \delta_{0} + 2 \sqrt{2 \Delta \delta_{0} + \delta_{0}^{2}}}{\Delta}\right\}
  \end{split}
\end{equation*}
