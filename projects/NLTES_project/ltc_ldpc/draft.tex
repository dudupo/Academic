...
Assume for the moment that any heavy edge contribute a low degree polynomial. Therefore the local view on $v$ is at distance at most $ \left( \Delta - C \right)\left( \Delta - R \right) $ from $C_{0}\otimes C_{0}$. So $d(x|_{v}$
