...
\begin{proof}
  ...
  Hence by shawartz zimpel lemma we have that $\gamma RC \le \left( d + \Delta \right)$. On the other hand, the number of weight of $c$ is at least: 
\begin{equation*}
    \begin{split}
      |c| \ge \left( R + C  \right) \delta_{0}\Delta - RC \cdot \gamma  \ge \left( R + C \right)\delta_{0}\Delta - \left( d + \Delta  \right)
    \end{split}
  \end{equation*}
  Combine the fact that $|c| \le \Delta^{1 \frac{1}{2}}$ we obtain that: 
  \begin{equation*}
    \begin{split}
      R + C \le \frac{d + \Delta}{\delta_{0} \Delta} + \frac{\Delta^{\frac{1}{2}}}{\delta_{0}}
    \end{split}
  \end{equation*}
\end{proof}
