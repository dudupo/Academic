  ...
  \begin{definition} \label{good-code} We will say that a family of codes is a \textit{good code} if its parameters converge into positive values. 
  \end{definition}
