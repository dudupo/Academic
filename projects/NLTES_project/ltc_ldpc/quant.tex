...
\begin{definition}{Abelian Square Complex}
  Let $\Gamma$ be abelian group at order $|\Gamma| = n$. And consider a disjointness subsets pair $A,B \subset \Gamma$. Define the generators set $S_{\pm}  = \left\{ b^{\pm 1} a : a \in A, b \in B   \right\}$. In addition define the map $f : \Gamma \times \Gamma \rightarrow \left[ \ \frac{1}{2} |S_{\pm}| \cdot |\Gamma|  \ \right]  $. 
\end{definition}
