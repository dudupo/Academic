...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_17 = Integer(17); _sage_const_3000 = Integer(3000); _sage_const_2 = Integer(2); _sage_const_14 = Integer(14); _sage_const_65 = Integer(65)## This file (poly_qldpc.sagetex.sage) was *autogenerated* from poly_qldpc.tex with sagetex.sty version 2021/10/16 v3.6.
import sagetex
_st_ = sagetex.SageTeXProcessor('poly_qldpc', version='2021/10/16 v3.6', version_check=True)
