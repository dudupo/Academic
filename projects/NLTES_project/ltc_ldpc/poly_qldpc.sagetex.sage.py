...
# This file was *autogenerated* from the file poly_qldpc.sagetex.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_17 = Integer(17); _sage_const_3000 = Integer(3000); _sage_const_47 = Integer(47); _sage_const_22 = Integer(22); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_33 = Integer(33); _sage_const_36 = Integer(36); _sage_const_37 = Integer(37)## This file (poly_qldpc.sagetex.sage) was *autogenerated* from poly_qldpc.tex with sagetex.sty version 2020/08/12 v3.5.
import sagetex
_st_ = sagetex.SageTeXProcessor('poly_qldpc', version='2020/08/12 v3.5', version_check=True)
...
try:
 ...
 _st_.inline(_sage_const_0 , print_capt('$' + latex(f) + '$ and $' + latex(g) +'$'))
except:
