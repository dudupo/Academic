...
\begin{tikzpicture}[x=0.5cm, y=0.5cm, >=stealth]
  ...
  \draw [->] (v-3) -- (v-11);
  \draw [->] (v-3) -- (v-12);
\draw[-] (v-4) -- (-9, -8) -- (-7, -8) -- (v-4) ;
\draw[-] (v-5) -- (-7, -8) -- (-5, -8) -- (v-5) ;
\draw[-] (v-6) -- (-5, -8) -- (-3, -8) -- (v-6) ;
\draw[-] (v-7) -- (-3, -8) -- (-1, -8) -- (v-7) ;
\draw[-] (v-8) -- (-1, -8) -- (1, -8) -- (v-8) ;
\draw[-] (v-9) -- (1, -8) -- (3, -8) -- (v-9) ;
\draw[-] (v-10) -- (3, -8) -- (5, -8) -- (v-10) ;
\draw[-] (v-11) -- (5, -8) -- (7, -8) -- (v-11) ;
\draw[-] (v-12) -- (7, -8) -- (9, -8) -- (v-12) ;
\draw[->] (v-14) -- (v-17);
\draw[->] (v-18) -- (v-15);
\draw[->] (v-13) -- (v-15);
\draw[->] (v-16) -- (v-17);
