...
In this work, we show a new upper bound $\PonB $ which tighter than the Singelton bound and holds for any good code.  We state the formal theorem in section 2.
