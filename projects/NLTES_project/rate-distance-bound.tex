...
\begin{multicols*}{2}
  ...
  Even it is obvious that any construction which resilient to a large number of faults should have a complexity price the exact relation between the rate and the distance of code.
