...
\else
  ...
  \addbibresource{./exactalgo-rs.bbl} 
\fi
...
\begin{table}[t]
	...
	{\footnotesize
		\begin{tabular}{l l l l}
			...
			%\textsc{Odd Cycle Transversal} &   $2.3146^k$  \cite{LokshtanovNRRS14}  & $1.5680^n$ &  $1.4391^n$  \\ 
			...
			%{\sc Cograph Deletion}&                   $??^k$          &      & deterministic    \\
			...
			%{\sc    Vertex Cover} &                   $1.2738^k$ \cite{ChenKX10}       &   $1.2150^n$  (DNI)   & $1.1996^n$  \cite{XiaoN13}  \\
			...
			%{\sc    Weighted $2$-SAT}   &                   $1.2738^k$     \cite{MisraNRS10}      &   $1.2150^n$  (DNI) & $1.1996^n$    \\ \hline
			...
			\bottomrule
			%{\almsat} &                   $2.3146^k$          &  $1.5680^n$    &   NPR    \\ \hline
		\end{tabular}
