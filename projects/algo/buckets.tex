...
\begin{multicols*}{2}
  ...
  \begin{equation*}
    ...
    \end{split}
  \end{equation*} 
  Hence, if $f$ can be computed in sublinear time then we obtained am expected linear time algortihm for sorting. 
  \paragraph{Theorem.} There exists a family of distrubation $\mathcal{D}$ such that are 
